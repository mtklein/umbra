...
umbra_color umbra_load_color (struct umbra_builder*, umbra_ptr32, enum umbra_fmt);
void        umbra_store_color(struct umbra_builder*, umbra_ptr32, umbra_color, enum umbra_fmt);
