...
typedef umbra_val32 (*umbra_coverage_fn)(struct umbra_builder *, struct umbra_uniforms *,
                                       umbra_val32 x, umbra_val32 y);
...
umbra_color umbra_shader_solid      (struct umbra_builder *, struct umbra_uniforms *, umbra_val32 x, umbra_val32 y);
umbra_color umbra_shader_linear_2   (struct umbra_builder *, struct umbra_uniforms *, umbra_val32 x, umbra_val32 y);
umbra_color umbra_shader_radial_2   (struct umbra_builder *, struct umbra_uniforms *, umbra_val32 x, umbra_val32 y);
umbra_color umbra_shader_linear_grad(struct umbra_builder *, struct umbra_uniforms *, umbra_val32 x, umbra_val32 y);
umbra_color umbra_shader_radial_grad(struct umbra_builder *, struct umbra_uniforms *, umbra_val32 x, umbra_val32 y);
...
umbra_val32 umbra_coverage_rect         (struct umbra_builder *, struct umbra_uniforms *, umbra_val32 x, umbra_val32 y);
umbra_val32 umbra_coverage_bitmap       (struct umbra_builder *, struct umbra_uniforms *, umbra_val32 x, umbra_val32 y);
umbra_val32 umbra_coverage_sdf          (struct umbra_builder *, struct umbra_uniforms *, umbra_val32 x, umbra_val32 y);
umbra_val32 umbra_coverage_bitmap_matrix(struct umbra_builder *, struct umbra_uniforms *, umbra_val32 x, umbra_val32 y);
umbra_val32 umbra_coverage_wind         (struct umbra_builder *, struct umbra_uniforms *, umbra_val32 x, umbra_val32 y);
