---
name: tidy
description: Apply /preview to the whole codebase, not just unpushed commits
---

Apply the same scrutiny as `/preview` but to the entire codebase rather than
just unpublished commits.
...
- Ambiguous, unclear or inconsistent identifier names
