...
umbra_color umbra_blend_src(struct umbra_basic_block*,
                            umbra_color src,
                            umbra_color dst);
umbra_color umbra_blend_srcover(struct umbra_basic_block*,
                                umbra_color src,
                                umbra_color dst);
umbra_color umbra_blend_dstover(struct umbra_basic_block*,
                                umbra_color src,
                                umbra_color dst);
umbra_color umbra_blend_multiply(struct umbra_basic_block*,
                                 umbra_color src,
                                 umbra_color dst);
...
umbra_color
umbra_transfer_apply(struct umbra_basic_block*,
                     umbra_color,
                     umbra_transfer const*);
umbra_color
umbra_transfer_invert(struct umbra_basic_block*,
                      umbra_color,
                      umbra_transfer const*);
