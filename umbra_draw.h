...
typedef umbra_v32   (*umbra_coverage_fn)(struct umbra_basic_block*, umbra_v32 x, umbra_v32 y);
...
umbra_color umbra_supersample(struct umbra_basic_block*, umbra_v32 x, umbra_v32 y,
...
umbra_v32 umbra_coverage_rect         (struct umbra_basic_block*, umbra_v32 x, umbra_v32 y);
umbra_v32 umbra_coverage_bitmap       (struct umbra_basic_block*, umbra_v32 x, umbra_v32 y);
umbra_v32 umbra_coverage_sdf          (struct umbra_basic_block*, umbra_v32 x, umbra_v32 y);
umbra_v32 umbra_coverage_bitmap_matrix(struct umbra_basic_block*, umbra_v32 x, umbra_v32 y);
...
umbra_color umbra_load_565    (struct umbra_basic_block*, umbra_ptr ptr, umbra_v32 ix);
void        umbra_store_565   (struct umbra_basic_block*, umbra_ptr ptr, umbra_v32 ix, umbra_color);
umbra_color umbra_load_1010102(struct umbra_basic_block*, umbra_ptr ptr, umbra_v32 ix);
void        umbra_store_1010102(struct umbra_basic_block*,umbra_ptr ptr, umbra_v32 ix, umbra_color);
...
umbra_color umbra_load_fp16_planar (struct umbra_basic_block*, umbra_ptr ptr, umbra_v32 ix);
void        umbra_store_fp16_planar(struct umbra_basic_block*, umbra_ptr ptr, umbra_v32 ix, umbra_color);
