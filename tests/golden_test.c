...
TEST(test_slug_rect) {
    ...
    struct umbra_coverage *cov = umbra_coverage_wrap(umbra_coverage_winding, &wind_uniform);
...
TEST(test_perspective_text) {
    ...
    struct umbra_coverage *cov2 = umbra_coverage_wrap(umbra_coverage_bitmap_matrix, &state2);
