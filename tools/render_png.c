...
static void render_slide(char const *label, struct umbra_backend *be, struct slide *s) {
    ...
    struct umbra_uniforms_layout *fill_uni = calloc(1, sizeof(struct umbra_uniforms_layout));
    size_t fi = umbra_uniforms_reserve_f32(fill_uni, 4);
    umbra_color fc = {
        umbra_uniform_32(fb, (umbra_ptr32){0}, fi),
        umbra_uniform_32(fb, (umbra_ptr32){0}, fi + 4),
        umbra_uniform_32(fb, (umbra_ptr32){0}, fi + 8),
        umbra_uniform_32(fb, (umbra_ptr32){0}, fi + 12),
    };
    umbra_store_8888(fb, (umbra_ptr32){.ix=1}, fc);
    ...
    umbra_color rc = umbra_load_8888(rb, (umbra_ptr32){.ix=1});
    umbra_store_8888(rb, (umbra_ptr32){.ix=2}, rc);
