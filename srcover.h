...
static inline struct umbra_basic_block* build_srcover(void) {
    ...
    umbra_v16  mask   = umbra_imm_16(bb, 0xff);
    umbra_v16  ri     = umbra_and_16(bb, umbra_i16_from_i32(bb, src), mask);
    umbra_half sr     = umbra_mul_half(bb, umbra_half_from_i16(bb, ri), inv255);
    umbra_v16  gi     = umbra_and_16(bb, umbra_i16_from_i32(bb, umbra_shr_u32(bb, src, umbra_imm_32(bb, 8))), mask);
    umbra_half sg     = umbra_mul_half(bb, umbra_half_from_i16(bb, gi), inv255);
    umbra_v16  bi     = umbra_and_16(bb, umbra_i16_from_i32(bb, umbra_shr_u32(bb, src, umbra_imm_32(bb, 16))), mask);
    umbra_half sb     = umbra_mul_half(bb, umbra_half_from_i16(bb, bi), inv255);
    umbra_v16  ai     = umbra_i16_from_i32(bb, umbra_shr_u32(bb, src, umbra_imm_32(bb, 24)));
