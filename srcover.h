...
static inline struct umbra_builder* build_srcover(void) {
    ...
    umbra_val sr     = umbra_mul_f32(builder, umbra_cvt_f32_i32(builder, rgba[0]), inv255),
              sg     = umbra_mul_f32(builder, umbra_cvt_f32_i32(builder, rgba[1]), inv255),
              sb     = umbra_mul_f32(builder, umbra_cvt_f32_i32(builder, rgba[2]), inv255),
              sa     = umbra_mul_f32(builder, umbra_cvt_f32_i32(builder, rgba[3]), inv255),
