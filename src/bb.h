...
#define OP_LIST(X)                                                                        \
    ...
    X(imm_32)                                                                             \
    X(uniform_32)                                                                         \
    X(load_32) X(load_32x2) X(load_8x4) X(load_color) X(gather_uniform_32) X(gather_32) \
    X(store_32) X(store_32x2) X(store_8x4) X(store_color) X(deref_ptr) X(add_f32) X(sub_f32)                           \
