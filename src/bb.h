...
#define OTHER_OPS(X)                                                                       \
    ...
    X(load_32) X(load_16x4) X(load_16x4_planar) X(load_8x4) X(gather_uniform_32) X(gather_32) \
    X(sample_32) X(store_32) X(store_16x4) X(store_16x4_planar) X(store_8x4) X(deref_ptr) \
