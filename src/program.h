...
void umbra_interpreter_run(struct umbra_interpreter *, int n, int w, umbra_buf[]);
void umbra_interpreter_free(struct umbra_interpreter *);

struct umbra_jit *umbra_jit(struct umbra_basic_block const *);
void              umbra_jit_run(struct umbra_jit *, int n, int w, umbra_buf[]);
...
void                umbra_metal_run(struct umbra_metal *, int n, int w, umbra_buf[]);
