...
void umbra_interpreter_run(struct umbra_interpreter *, int w, int h, int x0, int y0, umbra_buf[]);
void umbra_interpreter_free(struct umbra_interpreter *);

struct umbra_jit *umbra_jit(struct umbra_basic_block const *);
void              umbra_jit_run(struct umbra_jit *, int w, int h, int x0, int y0, umbra_buf[]);
...
void                umbra_metal_run(struct umbra_metal *, int w, int h, int x0, int y0, umbra_buf[]);
