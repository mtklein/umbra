...
kernel void umbra_entry(
    ...
    uint v15 = (((device uint*)(p1 + y * buf_rbs[1]))[x] >> 24) & 0xFFu;
    uint v16 = as_type<uint>((float)(int)v15);
    uint v17 = as_type<uint>(as_type<float>(v16) * as_type<float>(998277249u));
    uint v18 = as_type<uint>(fma(as_type<float>(v17), as_type<float>(v8), as_type<float>(v4)));
    ...
    uint v25 = (((device uint*)(p1 + y * buf_rbs[1]))[x] >> 0) & 0xFFu;
    ...
    uint v35 = (((device uint*)(p1 + y * buf_rbs[1]))[x] >> 8) & 0xFFu;
    uint v36 = as_type<uint>((float)(int)v35);
    uint v37 = as_type<uint>(as_type<float>(v36) * as_type<float>(998277249u));
    uint v38 = as_type<uint>(fma(as_type<float>(v37), as_type<float>(v8), as_type<float>(v2)));
    ...
    uint v45 = (((device uint*)(p1 + y * buf_rbs[1]))[x] >> 16) & 0xFFu;
    uint v46 = as_type<uint>((float)(int)v45);
    uint v47 = as_type<uint>(as_type<float>(v46) * as_type<float>(998277249u));
    uint v48 = as_type<uint>(fma(as_type<float>(v47), as_type<float>(v8), as_type<float>(v3)));
    uint v49 = as_type<uint>(as_type<float>(v48) - as_type<float>(v47));
    uint v50 = as_type<uint>(fma(as_type<float>(v13), as_type<float>(v49), as_type<float>(v47)));
    ...
    ((device uint*)(p1 + y * buf_rbs[1]))[x] = (v34 & 0xFFu) | ((v44 & 0xFFu) << 8) | ((v54 & 0xFFu) << 16) | (v24 << 24);
}
