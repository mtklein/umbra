...
kernel void umbra_entry(
    ...
    uint v12 = ((device uint*)p0)[i];
    uint v13 = v12 & v7;
    uint v14 = as_type<uint>((float)(int)v13);
    uint v15 = (uint)((device ushort*)p2)[i];
    ...
    uint v19 = as_type<uint>(as_type<float>(v6) * as_type<float>(v14));
    uint v20 = as_type<uint>(fma(as_type<float>(v19), as_type<float>(v9), as_type<float>(v1)));
    uint v21 = as_type<uint>(as_type<float>(v20) - as_type<float>(v6) * as_type<float>(v14));
    uint v22 = as_type<uint>(as_type<float>(v18) * as_type<float>(v21));
    uint v23 = as_type<uint>(fma(as_type<float>(v6), as_type<float>(v14), as_type<float>(v22)));
    uint v24 = as_type<uint>(fma(as_type<float>(v23), as_type<float>(v10), as_type<float>(v11)));
    ...
    uint v32 = as_type<uint>(as_type<float>(v31) - as_type<float>(v6) * as_type<float>(v29));
    uint v33 = as_type<uint>(as_type<float>(v18) * as_type<float>(v32));
    uint v34 = as_type<uint>(fma(as_type<float>(v6), as_type<float>(v29), as_type<float>(v33)));
    uint v35 = as_type<uint>(fma(as_type<float>(v34), as_type<float>(v10), as_type<float>(v11)));
    ...
    uint v45 = as_type<uint>(as_type<float>(v44) - as_type<float>(v6) * as_type<float>(v42));
    uint v46 = as_type<uint>(as_type<float>(v18) * as_type<float>(v45));
    uint v47 = as_type<uint>(fma(as_type<float>(v6), as_type<float>(v42), as_type<float>(v46)));
    ...
    uint v57 = as_type<uint>(as_type<float>(v56) - as_type<float>(v6) * as_type<float>(v54));
    uint v58 = as_type<uint>(as_type<float>(v18) * as_type<float>(v57));
    uint v59 = as_type<uint>(fma(as_type<float>(v6), as_type<float>(v54), as_type<float>(v58)));
    uint v60 = as_type<uint>(fma(as_type<float>(v59), as_type<float>(v10), as_type<float>(v11)));
