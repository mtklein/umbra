...
kernel void umbra_entry(
    ...
    uint v2 = ((device const uint*)p0)[2];
    uint v3 = ((device const uint*)p0)[3];
    uint v4 = ((device const uint*)p0)[4];
    ...
    uint v14 = pos.x;
    uint v15 = v14 + v13;
    uint v16 = (uint)((device ushort*)p2)[clamp_ix((int)v15,buf_szs[2],2)];
