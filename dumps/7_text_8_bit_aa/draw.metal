...
kernel void umbra_entry(
    ...
    uint v14_px = ((device uint*)(p1 + y * buf_rbs[1]))[x];
    uint v14 = v14_px & 0xFFu;
    uint v14_1 = (v14_px >> 8) & 0xFFu;
    uint v14_2 = (v14_px >> 16) & 0xFFu;
    uint v14_3 = v14_px >> 24;
    uint v15 = as_type<uint>((float)(int)v14_3);
    ...
    uint v19 = as_type<uint>(fma(as_type<float>(v13), as_type<float>(v18), as_type<float>(v16)));
    ...
    uint v24 = as_type<uint>((float)(int)v14);
    ...
    uint v33 = as_type<uint>((float)(int)v14_1);
    uint v34 = as_type<uint>(as_type<float>(v33) * as_type<float>(998277249u));
    uint v35 = as_type<uint>(fma(as_type<float>(v34), as_type<float>(v8), as_type<float>(v2)));
    uint v36 = as_type<uint>(as_type<float>(v35) - as_type<float>(v34));
    uint v37 = as_type<uint>(fma(as_type<float>(v13), as_type<float>(v36), as_type<float>(v34)));
    ...
    uint v42 = as_type<uint>((float)(int)v14_2);
    uint v43 = as_type<uint>(as_type<float>(v42) * as_type<float>(998277249u));
    uint v44 = as_type<uint>(fma(as_type<float>(v43), as_type<float>(v8), as_type<float>(v3)));
    uint v45 = as_type<uint>(as_type<float>(v44) - as_type<float>(v43));
    uint v46 = as_type<uint>(fma(as_type<float>(v13), as_type<float>(v45), as_type<float>(v43)));
    ...
    ((device uint*)(p1 + y * buf_rbs[1]))[x] = (v32 & 0xFFu) | ((v41 & 0xFFu) << 8) | ((v50 & 0xFFu) << 16) | (v23 << 24);
}
