...
kernel void umbra_entry(
    ...
    uint v36 = as_type<float>(v35) <  as_type<float>(v16) ? 0xffffffffu : 0u;
    uint v37 = as_type<uint>(as_type<float>(v28) * as_type<float>(v7));
    uint v38 = as_type<uint>(fma(as_type<float>(v26), as_type<float>(v6), as_type<float>(v37)));
    uint v39 = as_type<uint>(as_type<float>(v8) + as_type<float>(v38));
    uint v40 = as_type<uint>(as_type<float>(v39) / as_type<float>(v34));
    ...
    uint v44 = as_type<uint>((int)floor(as_type<float>(v43)));
    uint v45 = as_type<uint>(max(as_type<float>(v35), as_type<float>(0u)));
    uint v46 = as_type<uint>(min(as_type<float>(v45), as_type<float>(v19)));
    uint v47 = as_type<uint>((int)floor(as_type<float>(v46)));
    uint v48 = v47 * v20;
    uint v49 = v44 + v48;
