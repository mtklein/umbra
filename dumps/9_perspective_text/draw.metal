...
kernel void umbra_entry(
    ...
    uint v59_px = ((device uint*)(p1 + y * buf_rbs[1]))[x];
    uint v59 = v59_px & 0xFFu;
    uint v59_1 = (v59_px >> 8) & 0xFFu;
    uint v59_2 = (v59_px >> 16) & 0xFFu;
    uint v59_3 = v59_px >> 24;
    uint v60 = as_type<uint>((float)(int)v59_3);
    uint v61 = as_type<uint>(as_type<float>(v60) * as_type<float>(998277249u));
    uint v62 = as_type<uint>(fma(as_type<float>(v61), as_type<float>(v22), as_type<float>(v4)));
    uint v63 = as_type<uint>(as_type<float>(v62) - as_type<float>(v61));
    uint v64 = as_type<uint>(fma(as_type<float>(v58), as_type<float>(v63), as_type<float>(v61)));
    ...
    uint v69 = as_type<uint>((float)(int)v59);
    uint v70 = as_type<uint>(as_type<float>(v69) * as_type<float>(998277249u));
    uint v71 = as_type<uint>(fma(as_type<float>(v70), as_type<float>(v22), as_type<float>(v1)));
    uint v72 = as_type<uint>(as_type<float>(v71) - as_type<float>(v70));
    uint v73 = as_type<uint>(fma(as_type<float>(v58), as_type<float>(v72), as_type<float>(v70)));
    uint v74 = as_type<uint>(max(as_type<float>(v73), as_type<float>(0u)));
    uint v75 = as_type<uint>(min(as_type<float>(v74), as_type<float>(1065353216u)));
    uint v76 = as_type<uint>(as_type<float>(v75) * as_type<float>(1132396544u));
    uint v77 = as_type<uint>((int)rint(as_type<float>(v76)));
    uint v78 = as_type<uint>((float)(int)v59_1);
    uint v79 = as_type<uint>(as_type<float>(v78) * as_type<float>(998277249u));
    uint v80 = as_type<uint>(fma(as_type<float>(v79), as_type<float>(v22), as_type<float>(v2)));
    uint v81 = as_type<uint>(as_type<float>(v80) - as_type<float>(v79));
    uint v82 = as_type<uint>(fma(as_type<float>(v58), as_type<float>(v81), as_type<float>(v79)));
    uint v83 = as_type<uint>(max(as_type<float>(v82), as_type<float>(0u)));
    uint v84 = as_type<uint>(min(as_type<float>(v83), as_type<float>(1065353216u)));
    uint v85 = as_type<uint>(as_type<float>(v84) * as_type<float>(1132396544u));
    uint v86 = as_type<uint>((int)rint(as_type<float>(v85)));
    uint v87 = as_type<uint>((float)(int)v59_2);
    uint v88 = as_type<uint>(as_type<float>(v87) * as_type<float>(998277249u));
    uint v89 = as_type<uint>(fma(as_type<float>(v88), as_type<float>(v22), as_type<float>(v3)));
    uint v90 = as_type<uint>(as_type<float>(v89) - as_type<float>(v88));
    uint v91 = as_type<uint>(fma(as_type<float>(v58), as_type<float>(v90), as_type<float>(v88)));
    uint v92 = as_type<uint>(max(as_type<float>(v91), as_type<float>(0u)));
    uint v93 = as_type<uint>(min(as_type<float>(v92), as_type<float>(1065353216u)));
    uint v94 = as_type<uint>(as_type<float>(v93) * as_type<float>(1132396544u));
    uint v95 = as_type<uint>((int)rint(as_type<float>(v94)));
    ((device uint*)(p1 + y * buf_rbs[1]))[x] = (v77 & 0xFFu) | ((v86 & 0xFFu) << 8) | ((v95 & 0xFFu) << 16) | (v68 << 24);
}
