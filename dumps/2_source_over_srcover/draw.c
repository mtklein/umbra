...
void umbra_entry(int n, void **ptrs, long *szs) {
    ...
    for (int i = 0; i < n; i++) {
        ...
        u32 v33 = f2u(fmaf(u2f(v32), u2f(v18), u2f(v4)));
        u32 v34 = f2u(fmaf(-u2f(v17), u2f(v23), u2f(v33)));
        u32 v35 = f2u(u2f(v31) * u2f(v34));
        u32 v36 = f2u(fmaf(u2f(v17), u2f(v23), u2f(v35)));
        u32 v37 = f2u(fmaf(u2f(v36), u2f(v19), u2f(v20)));
        u32 v38 = (u32)(s32)u2f(v37);
        u32 v39 = (u32)(v16 & v38);
        u32 v40 = (u32)(v21 >> 8);
        u32 v41 = (u32)(v16 & v40);
        u32 v42 = f2u((float)(s32)v41);
        u32 v43 = f2u(u2f(v17) * u2f(v42));
        u32 v44 = f2u(fmaf(u2f(v43), u2f(v18), u2f(v5)));
        u32 v45 = f2u(fmaf(-u2f(v17), u2f(v42), u2f(v44)));
        u32 v46 = f2u(u2f(v31) * u2f(v45));
        u32 v47 = f2u(fmaf(u2f(v17), u2f(v42), u2f(v46)));
        u32 v48 = f2u(fmaf(u2f(v47), u2f(v19), u2f(v20)));
        ...
        u32 v53 = (u32)(v21 >> 16);
        u32 v54 = (u32)(v16 & v53);
        u32 v55 = f2u((float)(s32)v54);
        u32 v56 = f2u(u2f(v17) * u2f(v55));
        u32 v57 = f2u(fmaf(u2f(v56), u2f(v18), u2f(v6)));
        u32 v58 = f2u(fmaf(-u2f(v17), u2f(v55), u2f(v57)));
        u32 v59 = f2u(u2f(v31) * u2f(v58));
        u32 v60 = f2u(fmaf(u2f(v17), u2f(v55), u2f(v59)));
        u32 v61 = f2u(fmaf(u2f(v60), u2f(v19), u2f(v20)));
        u32 v62 = (u32)(s32)u2f(v61);
        u32 v63 = (u32)(v16 & v62);
        u32 v64 = (u32)(v63 << 16);
        u32 v65 = (u32)(v52 | v64);
        u32 v66 = (u32)(v21 >> 24);
        u32 v67 = f2u((float)(s32)v66);
        u32 v68 = f2u(u2f(v17) * u2f(v67));
        u32 v69 = f2u(fmaf(u2f(v68), u2f(v18), u2f(v7)));
        u32 v70 = f2u(fmaf(-u2f(v17), u2f(v67), u2f(v69)));
        u32 v71 = f2u(u2f(v31) * u2f(v70));
        u32 v72 = f2u(fmaf(u2f(v17), u2f(v67), u2f(v71)));
        u32 v73 = f2u(fmaf(u2f(v72), u2f(v19), u2f(v20)));
