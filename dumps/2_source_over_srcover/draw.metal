...
kernel void umbra_entry(
    ...
    uint v46 = as_type<uint>(fma(as_type<float>(v28), as_type<float>(v45), as_type<float>(v43)));
    uint v47 = as_type<uint>(as_type<float>(v46) * as_type<float>(v19));
    uint v48 = as_type<uint>(as_type<float>(v20) + as_type<float>(v47));
    ...
    uint v59 = as_type<uint>(fma(as_type<float>(v28), as_type<float>(v58), as_type<float>(v56)));
    uint v60 = as_type<uint>(as_type<float>(v59) * as_type<float>(v19));
    uint v61 = as_type<uint>(as_type<float>(v20) + as_type<float>(v60));
    ...
    uint v70 = as_type<uint>(as_type<float>(v69) - as_type<float>(v68));
    uint v71 = as_type<uint>(fma(as_type<float>(v28), as_type<float>(v70), as_type<float>(v68)));
    uint v72 = as_type<uint>(as_type<float>(v71) * as_type<float>(v19));
    uint v73 = as_type<uint>(as_type<float>(v20) + as_type<float>(v72));
