...
kernel void umbra_entry(
    ...
    uint v41 = as_type<uint>(fma(as_type<float>(v40), as_type<float>(v12), as_type<float>(v2)));
    uint v42 = as_type<uint>(as_type<float>(v41) - as_type<float>(v40));
    uint v43 = as_type<uint>(fma(as_type<float>(v25), as_type<float>(v42), as_type<float>(v40)));
