...
kernel void umbra_entry(
    ...
    uint v41 = as_type<uint>(fma(as_type<float>(v25), as_type<float>(v40), as_type<float>(v38)));
    ...
    uint v49 = as_type<uint>(fma(as_type<float>(v48), as_type<float>(v12), as_type<float>(v3)));
    uint v50 = as_type<uint>(as_type<float>(v49) - as_type<float>(v48));
    uint v51 = as_type<uint>(fma(as_type<float>(v25), as_type<float>(v50), as_type<float>(v48)));
    ...
    uint v58 = as_type<uint>(fma(as_type<float>(v57), as_type<float>(v12), as_type<float>(v1)));
    uint v59 = as_type<uint>(as_type<float>(v58) - as_type<float>(v57));
    uint v60 = as_type<uint>(fma(as_type<float>(v25), as_type<float>(v59), as_type<float>(v57)));
