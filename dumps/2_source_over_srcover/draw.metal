...
kernel void umbra_entry(
    ...
    uint v29 = as_type<uint>(fma(as_type<float>(v28), as_type<float>(v11), as_type<float>(v4)));
    uint v30 = as_type<uint>(as_type<float>(v29) - as_type<float>(v28));
    uint v31 = as_type<uint>(fma(as_type<float>(v24), as_type<float>(v30), as_type<float>(v28)));
    ...
    uint v49 = as_type<uint>(fma(as_type<float>(v48), as_type<float>(v11), as_type<float>(v2)));
    ...
    uint v59 = as_type<uint>(fma(as_type<float>(v58), as_type<float>(v11), as_type<float>(v3)));
    uint v60 = as_type<uint>(as_type<float>(v59) - as_type<float>(v58));
    uint v61 = as_type<uint>(fma(as_type<float>(v24), as_type<float>(v60), as_type<float>(v58)));
