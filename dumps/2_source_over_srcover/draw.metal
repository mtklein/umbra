...
kernel void umbra_entry(
    ...
    uint v32 = as_type<uint>(fma(as_type<float>(v31), as_type<float>(v18), as_type<float>(v7)));
    uint v33 = as_type<uint>(as_type<float>(v32) - as_type<float>(v31));
    uint v34 = as_type<uint>(fma(as_type<float>(v27), as_type<float>(v33), as_type<float>(v31)));
    uint v35 = as_type<uint>(as_type<float>(v34) * as_type<float>(v19));
    ...
    uint v46 = as_type<uint>(fma(as_type<float>(v45), as_type<float>(v18), as_type<float>(v4)));
    uint v47 = as_type<uint>(as_type<float>(v46) - as_type<float>(v45));
    uint v48 = as_type<uint>(fma(as_type<float>(v27), as_type<float>(v47), as_type<float>(v45)));
    uint v49 = as_type<uint>(as_type<float>(v17) * as_type<float>(v41));
    uint v50 = as_type<uint>(fma(as_type<float>(v49), as_type<float>(v18), as_type<float>(v5)));
    uint v51 = as_type<uint>(as_type<float>(v50) - as_type<float>(v49));
    uint v52 = as_type<uint>(fma(as_type<float>(v27), as_type<float>(v51), as_type<float>(v49)));
    uint v53 = as_type<uint>(as_type<float>(v17) * as_type<float>(v44));
    uint v54 = as_type<uint>(fma(as_type<float>(v53), as_type<float>(v18), as_type<float>(v6)));
    uint v55 = as_type<uint>(as_type<float>(v54) - as_type<float>(v53));
    uint v56 = as_type<uint>(fma(as_type<float>(v27), as_type<float>(v55), as_type<float>(v53)));
    uint v57 = as_type<uint>(as_type<float>(v48) * as_type<float>(v19));
    uint v58 = as_type<uint>((int)rint(as_type<float>(v57)));
    uint v59 = as_type<uint>(as_type<float>(v52) * as_type<float>(v19));
    uint v60 = as_type<uint>((int)rint(as_type<float>(v59)));
    uint v61 = as_type<uint>(as_type<float>(v56) * as_type<float>(v19));
