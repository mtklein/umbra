...
kernel void umbra_entry(
    ...
    uint v39 = as_type<uint>(fma(as_type<float>(v21), as_type<float>(v38), as_type<float>(v36)));
    uint v40 = as_type<uint>(as_type<float>(v39) * as_type<float>(v12));
    uint v41 = as_type<uint>(as_type<float>(v13) + as_type<float>(v40));
    ...
    uint v52 = as_type<uint>(fma(as_type<float>(v21), as_type<float>(v51), as_type<float>(v49)));
    uint v53 = as_type<uint>(as_type<float>(v52) * as_type<float>(v12));
    uint v54 = as_type<uint>(as_type<float>(v13) + as_type<float>(v53));
    ...
    uint v64 = as_type<uint>(fma(as_type<float>(v21), as_type<float>(v63), as_type<float>(v61)));
    uint v65 = as_type<uint>(as_type<float>(v64) * as_type<float>(v12));
    uint v66 = as_type<uint>(as_type<float>(v13) + as_type<float>(v65));
