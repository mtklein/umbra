...
kernel void umbra_entry(
    ...
    uint v35 = as_type<uint>(fma(as_type<float>(v34), as_type<float>(v11), as_type<float>(v2)));
    uint v36 = as_type<uint>(as_type<float>(v35) - as_type<float>(v34));
    uint v37 = as_type<uint>(fma(as_type<float>(v20), as_type<float>(v36), as_type<float>(v34)));
    ...
    uint v54 = v53 & 255u;
    uint v55 = as_type<uint>((int)rint(as_type<float>(v30)));
    uint v56 = v21 & 255u;
