...
kernel void umbra_entry(
    ...
    uint v21 = (((device uint*)(p1 + y * buf_rbs[1]))[x] >> 24) & 0xFFu;
    uint v22 = as_type<uint>((float)(int)v21);
    uint v23 = as_type<uint>(as_type<float>(v22) * as_type<float>(998277249u));
    uint v24 = as_type<uint>(fma(as_type<float>(v23), as_type<float>(v10), as_type<float>(v4)));
    ...
    uint v31 = (((device uint*)(p1 + y * buf_rbs[1]))[x] >> 0) & 0xFFu;
    uint v32 = as_type<uint>((float)(int)v31);
    uint v33 = as_type<uint>(as_type<float>(v32) * as_type<float>(998277249u));
    uint v34 = as_type<uint>(fma(as_type<float>(v33), as_type<float>(v10), as_type<float>(v1)));
    uint v35 = as_type<uint>(as_type<float>(v34) - as_type<float>(v33));
    uint v36 = as_type<uint>(fma(as_type<float>(v19), as_type<float>(v35), as_type<float>(v33)));
    ...
    uint v41 = (((device uint*)(p1 + y * buf_rbs[1]))[x] >> 8) & 0xFFu;
    uint v42 = as_type<uint>((float)(int)v41);
    uint v43 = as_type<uint>(as_type<float>(v42) * as_type<float>(998277249u));
    uint v44 = as_type<uint>(fma(as_type<float>(v43), as_type<float>(v10), as_type<float>(v2)));
    uint v45 = as_type<uint>(as_type<float>(v44) - as_type<float>(v43));
    uint v46 = as_type<uint>(fma(as_type<float>(v19), as_type<float>(v45), as_type<float>(v43)));
    ...
    uint v51 = (((device uint*)(p1 + y * buf_rbs[1]))[x] >> 16) & 0xFFu;
    uint v52 = as_type<uint>((float)(int)v51);
    uint v53 = as_type<uint>(as_type<float>(v52) * as_type<float>(998277249u));
    uint v54 = as_type<uint>(fma(as_type<float>(v53), as_type<float>(v10), as_type<float>(v3)));
    uint v55 = as_type<uint>(as_type<float>(v54) - as_type<float>(v53));
    uint v56 = as_type<uint>(fma(as_type<float>(v19), as_type<float>(v55), as_type<float>(v53)));
    ...
    ((device uint*)(p1 + y * buf_rbs[1]))[x] = (v40 & 0xFFu) | ((v50 & 0xFFu) << 8) | ((v60 & 0xFFu) << 16) | (v30 << 24);
}
