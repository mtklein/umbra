...
kernel void umbra_entry(
    ...
    float v23_2 = v23_c.z;
    float v23_3 = v23_c.w;
    float v24 = as_type<float>(v9) - v23_3;
    float v25 = v23_3 * v10;
    float v26 = fma(as_type<float>(v4), v24, v25);
    float v27 = fma(as_type<float>(v4), v23_3, v26);
    float v28 = v27 - v23_3;
    float v29 = fma(as_type<float>(v22), v28, v23_3);
    float v30 = v23 * v10;
    float v31 = fma(as_type<float>(v1), v24, v30);
    float v32 = fma(as_type<float>(v1), v23, v31);
    float v33 = v32 - v23;
    float v34 = fma(as_type<float>(v22), v33, v23);
    float v35 = v23_1 * v10;
    float v36 = fma(as_type<float>(v2), v24, v35);
    float v37 = fma(as_type<float>(v2), v23_1, v36);
    float v38 = v37 - v23_1;
    float v39 = fma(as_type<float>(v22), v38, v23_1);
    float v40 = v23_2 * v10;
    float v41 = fma(as_type<float>(v3), v24, v40);
    float v42 = fma(as_type<float>(v3), v23_2, v41);
    float v43 = v42 - v23_2;
    float v44 = fma(as_type<float>(v22), v43, v23_2);
    float4 sc45 = float4(v34, v39, v44, v29);
    if (planes_p1 == 1) {
