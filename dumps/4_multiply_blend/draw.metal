...
kernel void umbra_entry(
    ...
    uint v28 = as_type<uint>(as_type<float>(v27) * as_type<float>(v11));
    uint v29 = as_type<uint>((float)(int)v25);
    uint v30 = as_type<uint>(as_type<float>(v29) * as_type<float>(998277249u));
    uint v31 = as_type<uint>(as_type<float>(v30) * as_type<float>(v11));
    uint v32 = as_type<uint>((float)(int)v25_1);
    uint v33 = as_type<uint>(as_type<float>(v32) * as_type<float>(998277249u));
    uint v34 = as_type<uint>(as_type<float>(v33) * as_type<float>(v11));
    uint v35 = as_type<uint>((float)(int)v25_2);
    ...
    uint v38 = as_type<uint>(as_type<float>(v9) - as_type<float>(v27));
    uint v39 = as_type<uint>(fma(as_type<float>(v4), as_type<float>(v38), as_type<float>(v28)));
    uint v40 = as_type<uint>(fma(as_type<float>(v4), as_type<float>(v27), as_type<float>(v39)));
    uint v41 = as_type<uint>(as_type<float>(v40) - as_type<float>(v27));
    uint v42 = as_type<uint>(fma(as_type<float>(v24), as_type<float>(v41), as_type<float>(v27)));
    ...
    uint v47 = as_type<uint>(fma(as_type<float>(v1), as_type<float>(v38), as_type<float>(v31)));
    uint v48 = as_type<uint>(fma(as_type<float>(v1), as_type<float>(v30), as_type<float>(v47)));
    uint v49 = as_type<uint>(as_type<float>(v48) - as_type<float>(v30));
    uint v50 = as_type<uint>(fma(as_type<float>(v24), as_type<float>(v49), as_type<float>(v30)));
    ...
    uint v55 = as_type<uint>(fma(as_type<float>(v2), as_type<float>(v38), as_type<float>(v34)));
    uint v56 = as_type<uint>(fma(as_type<float>(v2), as_type<float>(v33), as_type<float>(v55)));
    uint v57 = as_type<uint>(as_type<float>(v56) - as_type<float>(v33));
    uint v58 = as_type<uint>(fma(as_type<float>(v24), as_type<float>(v57), as_type<float>(v33)));
    ...
    uint v63 = as_type<uint>(fma(as_type<float>(v3), as_type<float>(v38), as_type<float>(v37)));
    uint v64 = as_type<uint>(fma(as_type<float>(v3), as_type<float>(v36), as_type<float>(v63)));
    uint v65 = as_type<uint>(as_type<float>(v64) - as_type<float>(v36));
    uint v66 = as_type<uint>(fma(as_type<float>(v24), as_type<float>(v65), as_type<float>(v36)));
    ...
    ((device uint*)(p1 + y * buf_rbs[1]))[x] = (v54 & 0xFFu) | ((v62 & 0xFFu) << 8) | ((v70 & 0xFFu) << 16) | (v46 << 24);
}
