...
kernel void umbra_entry(
    ...
    uint v48 = as_type<uint>(as_type<float>(v47) - as_type<float>(v29));
    uint v49 = as_type<uint>(fma(as_type<float>(v25), as_type<float>(v48), as_type<float>(v29)));
    ...
    uint v54 = as_type<uint>(fma(as_type<float>(v1), as_type<float>(v45), as_type<float>(v44)));
    uint v55 = as_type<uint>(fma(as_type<float>(v1), as_type<float>(v43), as_type<float>(v54)));
    uint v56 = as_type<uint>(as_type<float>(v55) - as_type<float>(v43));
    uint v57 = as_type<uint>(fma(as_type<float>(v25), as_type<float>(v56), as_type<float>(v43)));
    ...
    uint v62 = v61 & 255u;
    uint v63 = as_type<uint>(fma(as_type<float>(v2), as_type<float>(v45), as_type<float>(v35)));
    uint v64 = as_type<uint>(fma(as_type<float>(v2), as_type<float>(v34), as_type<float>(v63)));
    uint v65 = as_type<uint>(as_type<float>(v64) - as_type<float>(v34));
    uint v66 = as_type<uint>(fma(as_type<float>(v25), as_type<float>(v65), as_type<float>(v34)));
    ...
    uint v71 = v70 & 255u;
    uint v72 = v62 | (v71 << 8u);
    uint v73 = as_type<uint>(fma(as_type<float>(v3), as_type<float>(v45), as_type<float>(v40)));
    uint v74 = as_type<uint>(fma(as_type<float>(v3), as_type<float>(v39), as_type<float>(v73)));
    uint v75 = as_type<uint>(as_type<float>(v74) - as_type<float>(v39));
    uint v76 = as_type<uint>(fma(as_type<float>(v25), as_type<float>(v75), as_type<float>(v39)));
    uint v77 = as_type<uint>(max(as_type<float>(v76), as_type<float>(0u)));
    uint v78 = as_type<uint>(min(as_type<float>(v77), as_type<float>(1065353216u)));
    uint v79 = as_type<uint>(as_type<float>(v78) * as_type<float>(1132396544u));
    uint v80 = as_type<uint>((int)rint(as_type<float>(v79)));
    uint v81 = v80 & 255u;
    uint v82 = v72 | (v81 << 16u);
    uint v83 = v82 | (v53 << 24u);
