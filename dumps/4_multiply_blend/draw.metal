...
kernel void umbra_entry(
    ...
    float v54 = fma(as_type<float>(v1), v45, v44);
    float v55 = fma(as_type<float>(v1), v43, v54);
    float v56 = v55 - v43;
    float v57 = fma(as_type<float>(v25), v56, v43);
    ...
    float v62 = fma(as_type<float>(v2), v45, v35);
    float v63 = fma(as_type<float>(v2), v34, v62);
    float v64 = v63 - v34;
    float v65 = fma(as_type<float>(v25), v64, v34);
    float v66 = max(v65, as_type<float>(0u));
    float v67 = min(v66, as_type<float>(1065353216u));
    float v68 = v67 * as_type<float>(1132396544u);
    uint v69 = (uint)(int)rint(v68);
    uint v70 = v61 | (v69 << 8u);
    float v71 = fma(as_type<float>(v3), v45, v40);
    float v72 = fma(as_type<float>(v3), v39, v71);
    float v73 = v72 - v39;
    float v74 = fma(as_type<float>(v25), v73, v39);
    float v75 = max(v74, as_type<float>(0u));
    float v76 = min(v75, as_type<float>(1065353216u));
    float v77 = v76 * as_type<float>(1132396544u);
    uint v78 = (uint)(int)rint(v77);
    uint v79 = v70 | (v78 << 16u);
    uint v80 = v79 | (v53 << 24u);
    ((device uint*)(p1 + y * buf_rbs[1]))[x] = v80;
}
