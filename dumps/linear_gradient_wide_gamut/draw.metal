...
kernel void umbra_entry(
    ...
    uint _lo23 = 0; if ((uint)(int)_si23 < buf_limit[2]) { _lo23 = p2[(int)_si23]; }
    uint _hi23 = 0; if ((uint)((int)_si23+1) < buf_limit[2]) { _hi23 = p2[(int)_si23+1]; }
    ...
    { uint _base = y * buf_stride[1] + x*4;
      p1[_base] = ushort(v24); p1[_base+1] = ushort(v30); p1[_base+2] = ushort(v33); p1[_base+3] = ushort(v27); }
}
