...
kernel void umbra_entry(
    ...
    uint v29 = v14 * v28;
    uint v30 = ((device uint*)p2)[clamp_ix((int)v29,buf_szs[2],4)];
    uint v31 = v3 + v29;
    uint v32 = ((device uint*)p2)[clamp_ix((int)v31,buf_szs[2],4)];
    uint v33 = v6 + v29;
    uint v34 = ((device uint*)p2)[clamp_ix((int)v33,buf_szs[2],4)];
    uint v35 = v8 + v29;
    uint v36 = ((device uint*)p2)[clamp_ix((int)v35,buf_szs[2],4)];
    uint v37 = v10 + v29;
