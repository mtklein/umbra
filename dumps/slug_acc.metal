...
kernel void umbra_entry(
    ...
    uint v60 = as_type<uint>(as_type<float>(v14) * as_type<float>(v59));
    ...
    uint v65 = v64 & v51;
    uint v66 = v63 & v65;
    uint v67 = as_type<uint>(as_type<float>(v14) * as_type<float>(v52));
    ...
    uint v72 = as_type<uint>(max(as_type<float>(v0), as_type<float>(v71)));
    ...
    uint v82 = as_type<uint>(as_type<float>(v61) - as_type<float>(v73));
    uint v83 = as_type<uint>(as_type<float>(v78) * as_type<float>(v82));
    uint v84 = as_type<uint>(fabs(as_type<float>(v61)));
    uint v85 = as_type<float>(v15) <  as_type<float>(v84) ? 0xffffffffu : 0u;
    uint v86 = as_type<uint>(as_type<float>(v14) * as_type<float>(v61));
    uint v87 = (v85 & v86) | (~v85 & v13);
    uint v88 = as_type<uint>(as_type<float>(v53) / as_type<float>(v87));
    uint v89 = (v76 & v83) | (~v76 & v88);
    uint v90 = as_type<uint>(as_type<float>(v69) * as_type<float>(v89));
    uint v91 = as_type<uint>(as_type<float>(v90) - as_type<float>(v61));
    uint v92 = as_type<float>(v89) <  as_type<float>(v13) ? 0xffffffffu : 0u;
    uint v93 = as_type<float>(v0) <= as_type<float>(v89) ? 0xffffffffu : 0u;
    uint v94 = v93 & v92;
    uint v95 = as_type<float>(v0) <= as_type<float>(v71) ? 0xffffffffu : 0u;
    uint v96 = v95 & v76;
    uint v97 = v95 & v94;
    uint v98 = as_type<float>(v79) <  as_type<float>(v13) ? 0xffffffffu : 0u;
    uint v99 = as_type<float>(v0) <= as_type<float>(v79) ? 0xffffffffu : 0u;
    uint v100 = v99 & v98;
    uint v101 = v96 & v100;
    uint v102 = as_type<uint>(as_type<float>(v14) * as_type<float>(v57));
    uint v103 = as_type<uint>(as_type<float>(v58) - as_type<float>(v102));
    uint v104 = as_type<uint>(as_type<float>(v55) + as_type<float>(v103));
    uint v105 = as_type<uint>(fma(as_type<float>(v79), as_type<float>(v104), as_type<float>(v60)));
    uint v106 = as_type<uint>(fma(as_type<float>(v79), as_type<float>(v105), as_type<float>(v58)));
    uint v107 = as_type<float>(v0) <  as_type<float>(v106) ? 0xffffffffu : 0u;
    uint v108 = v101 & v107;
    uint v109 = as_type<uint>(fma(as_type<float>(v89), as_type<float>(v104), as_type<float>(v60)));
    uint v110 = as_type<uint>(fma(as_type<float>(v89), as_type<float>(v109), as_type<float>(v58)));
    uint v111 = as_type<float>(v0) <  as_type<float>(v110) ? 0xffffffffu : 0u;
    uint v112 = v97 & v111;
    uint v113 = as_type<float>(v91) <  as_type<float>(v0) ? 0xffffffffu : 0u;
    uint v114 = (v113 & v35) | (~v113 & v0);
    uint v115 = as_type<float>(v0) <  as_type<float>(v91) ? 0xffffffffu : 0u;
    uint v116 = (v115 & v13) | (~v115 & v114);
    uint v117 = (v112 & v116) | (~v112 & v0);
    uint v118 = as_type<float>(v81) <  as_type<float>(v0) ? 0xffffffffu : 0u;
    uint v119 = (v118 & v35) | (~v118 & v0);
    uint v120 = as_type<float>(v0) <  as_type<float>(v81) ? 0xffffffffu : 0u;
    uint v121 = (v120 & v13) | (~v120 & v119);
    uint v122 = (v108 & v121) | (~v108 & v0);
    uint v123 = as_type<uint>(as_type<float>(v117) + as_type<float>(v122));
