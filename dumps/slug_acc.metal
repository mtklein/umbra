...
kernel void umbra_entry(
    ...
    uint v6 = 2u;
    uint v7 = ((device const uint*)p0)[2];
    uint v8 = 3u;
    uint v9 = ((device const uint*)p0)[3];
    uint v10 = 4u;
    uint v11 = ((device const uint*)p0)[4];
    uint v12 = 5u;
    uint v13 = ((device const uint*)p0)[5];
    uint v14 = 6u;
    uint v15 = ((device const uint*)p0)[6];
    uint v16 = ((device const uint*)p0)[7];
    uint v17 = ((device const uint*)p0)[8];
    uint v18 = ((device const uint*)p0)[9];
    uint v19 = ((device const uint*)p0)[10];
    uint v20 = ((device const uint*)p0)[11];
    uint v21 = ((device const uint*)p0)[12];
    ...
    uint v27 = 931135488u;
    uint v28 = ((device const uint*)p0)[18];
    uint v29 = v14 * v28;
