...
void umbra_entry(int n, void **ptrs, long *szs) {
    ...
    for (int i = 0; i < n; i++) {
        ...
        u32 v31 = f2u(fmaf(-u2f(v17), u2f(v22), u2f(v4)));
        u32 v32 = f2u(u2f(v30) * u2f(v31));
        u32 v33 = f2u(fmaf(u2f(v17), u2f(v22), u2f(v32)));
        u32 v34 = f2u(fmaf(u2f(v33), u2f(v18), u2f(v19)));
        u32 v35 = (u32)(s32)u2f(v34);
        u32 v36 = (u32)(v16 & v35);
        u32 v37 = (u32)(v20 >> 8);
        u32 v38 = (u32)(v16 & v37);
        u32 v39 = f2u((float)(s32)v38);
        u32 v40 = f2u(fmaf(-u2f(v17), u2f(v39), u2f(v5)));
        u32 v41 = f2u(u2f(v30) * u2f(v40));
        u32 v42 = f2u(fmaf(u2f(v17), u2f(v39), u2f(v41)));
        u32 v43 = f2u(fmaf(u2f(v42), u2f(v18), u2f(v19)));
        ...
        u32 v48 = (u32)(v20 >> 16);
        u32 v49 = (u32)(v16 & v48);
        u32 v50 = f2u((float)(s32)v49);
        u32 v51 = f2u(fmaf(-u2f(v17), u2f(v50), u2f(v6)));
        u32 v52 = f2u(u2f(v30) * u2f(v51));
        u32 v53 = f2u(fmaf(u2f(v17), u2f(v50), u2f(v52)));
        u32 v54 = f2u(fmaf(u2f(v53), u2f(v18), u2f(v19)));
        ...
        u32 v61 = f2u(fmaf(-u2f(v17), u2f(v60), u2f(v7)));
        u32 v62 = f2u(u2f(v30) * u2f(v61));
        u32 v63 = f2u(fmaf(u2f(v17), u2f(v60), u2f(v62)));
        u32 v64 = f2u(fmaf(u2f(v63), u2f(v18), u2f(v19)));
        u32 v65 = (u32)(s32)u2f(v64);
        u32 v66 = (u32)(v65 << 24);
        u32 v67 = (u32)(v58 | v66);
        p0[i] = v67;
    }
