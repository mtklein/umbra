...
kernel void umbra_entry(
    ...
    uint v31 = v30 & v18;
    uint v32 = as_type<uint>(as_type<float>(v5) * as_type<float>(v26));
    ...
    uint v37 = v36 << 8u;
    uint v38 = v31 | v37;
    uint v39 = as_type<uint>(as_type<float>(v6) * as_type<float>(v26));
    ...
    uint v44 = v43 << 16u;
    uint v45 = v38 | v44;
    uint v46 = as_type<uint>(as_type<float>(v7) * as_type<float>(v26));
