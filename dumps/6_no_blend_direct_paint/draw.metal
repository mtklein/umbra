...
kernel void umbra_entry(
    ...
    uint v39 = as_type<uint>(as_type<float>(v2) - as_type<float>(v38));
    uint v40 = as_type<uint>(fma(as_type<float>(v24), as_type<float>(v39), as_type<float>(v38)));
    ...
    uint v50 = as_type<uint>(as_type<float>(v3) - as_type<float>(v49));
    uint v51 = as_type<uint>(fma(as_type<float>(v24), as_type<float>(v50), as_type<float>(v49)));
    ...
    uint v59 = as_type<uint>(as_type<float>(v58) * as_type<float>(998277249u));
    uint v60 = as_type<uint>(as_type<float>(v1) - as_type<float>(v59));
    uint v61 = as_type<uint>(fma(as_type<float>(v24), as_type<float>(v60), as_type<float>(v59)));
    ...
    uint v66 = v65 & 255u;
    uint v67 = v66 | (v45 << 8u);
    uint v68 = v67 | (v56 << 16u);
    uint v69 = v68 | (v34 << 24u);
