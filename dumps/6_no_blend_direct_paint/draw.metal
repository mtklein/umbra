...
kernel void umbra_entry(
    ...
    uint v28 = as_type<uint>(as_type<float>(v4) - as_type<float>(v27));
    uint v29 = as_type<uint>(fma(as_type<float>(v23), as_type<float>(v28), as_type<float>(v27)));
    ...
    uint v34 = (((device uint*)(p1 + y * buf_rbs[1]))[x] >> 0) & 0xFFu;
    uint v35 = as_type<uint>((float)(int)v34);
    uint v36 = as_type<uint>(as_type<float>(v35) * as_type<float>(998277249u));
    uint v37 = as_type<uint>(as_type<float>(v1) - as_type<float>(v36));
    uint v38 = as_type<uint>(fma(as_type<float>(v23), as_type<float>(v37), as_type<float>(v36)));
    ...
    uint v43 = (((device uint*)(p1 + y * buf_rbs[1]))[x] >> 8) & 0xFFu;
    uint v44 = as_type<uint>((float)(int)v43);
    uint v45 = as_type<uint>(as_type<float>(v44) * as_type<float>(998277249u));
    uint v46 = as_type<uint>(as_type<float>(v2) - as_type<float>(v45));
    uint v47 = as_type<uint>(fma(as_type<float>(v23), as_type<float>(v46), as_type<float>(v45)));
    uint v48 = as_type<uint>(max(as_type<float>(v47), as_type<float>(0u)));
    uint v49 = as_type<uint>(min(as_type<float>(v48), as_type<float>(1065353216u)));
    uint v50 = as_type<uint>(as_type<float>(v49) * as_type<float>(1132396544u));
    uint v51 = as_type<uint>((int)rint(as_type<float>(v50)));
    uint v52 = (((device uint*)(p1 + y * buf_rbs[1]))[x] >> 16) & 0xFFu;
    uint v53 = as_type<uint>((float)(int)v52);
    uint v54 = as_type<uint>(as_type<float>(v53) * as_type<float>(998277249u));
    uint v55 = as_type<uint>(as_type<float>(v3) - as_type<float>(v54));
    uint v56 = as_type<uint>(fma(as_type<float>(v23), as_type<float>(v55), as_type<float>(v54)));
    ...
    ((device uint*)(p1 + y * buf_rbs[1]))[x] = (v42 & 0xFFu) | ((v51 & 0xFFu) << 8) | ((v60 & 0xFFu) << 16) | (v33 << 24);
}
