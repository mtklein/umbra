...
kernel void umbra_entry(
    ...
    float v28 = v27 * v11;
    float v29 = (float)(int)v25;
    float v30 = v29 * as_type<float>(998277249u);
    float v31 = v30 * v11;
    float v32 = (float)(int)v25_1;
    float v33 = v32 * as_type<float>(998277249u);
    float v34 = v33 * v11;
    float v35 = (float)(int)v25_2;
    float v36 = v35 * as_type<float>(998277249u);
    float v37 = v36 * v11;
    float v38 = as_type<float>(v9) - v27;
    float v39 = fma(as_type<float>(v4), v38, v28);
    float v40 = fma(as_type<float>(v4), v27, v39);
    float v41 = v40 - v27;
    float v42 = fma(as_type<float>(v24), v41, v27);
    ...
    float v47 = fma(as_type<float>(v1), v38, v31);
    float v48 = fma(as_type<float>(v1), v30, v47);
    float v49 = v48 - v30;
    float v50 = fma(as_type<float>(v24), v49, v30);
    ...
    float v55 = fma(as_type<float>(v2), v38, v34);
    float v56 = fma(as_type<float>(v2), v33, v55);
    float v57 = v56 - v33;
    float v58 = fma(as_type<float>(v24), v57, v33);
    ...
    float v63 = fma(as_type<float>(v3), v38, v37);
    float v64 = fma(as_type<float>(v3), v36, v63);
    float v65 = v64 - v36;
    float v66 = fma(as_type<float>(v24), v65, v36);
    ...
    ((device uint*)(p1 + y * buf_rbs[1]))[x] = (v54 & 0xFFu) | ((v62 & 0xFFu) << 8u) | ((v70 & 0xFFu) << 16u) | (v46 << 24u);
}
