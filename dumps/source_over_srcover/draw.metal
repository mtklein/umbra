...
kernel void umbra_entry(
    ...
    float v28 = fma(v27, v11, as_type<float>(v1));
    float v29 = v28 - v27;
    ...
    float v35 = (float)(int)v25_3;
    float v36 = v35 * as_type<float>(998277249u);
    float v37 = fma(v36, v11, as_type<float>(v4));
    float v38 = v37 - v36;
    ...
    ((device uint*)(p1 + y * buf_rbs[1]))[x] = (v34 & 0xFFu) | ((v52 & 0xFFu) << 8u) | ((v61 & 0xFFu) << 16u) | (v43 << 24u);
}
