...
kernel void umbra_entry(
    ...
    uint v35 = as_type<uint>(as_type<float>(v12) + as_type<float>(v34));
    ...
    uint v47 = as_type<uint>(as_type<float>(v46) * as_type<float>(v11));
    uint v48 = as_type<uint>(as_type<float>(v12) + as_type<float>(v47));
    ...
    uint v59 = as_type<uint>(as_type<float>(v58) * as_type<float>(v11));
    uint v60 = as_type<uint>(as_type<float>(v12) + as_type<float>(v59));
