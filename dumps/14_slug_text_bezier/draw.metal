...
kernel void umbra_entry(
    ...
    uint v13 = ((device uint*)p2)[i];
    uint v14 = v13 & v6;
    uint v15 = as_type<uint>(min(as_type<float>(v14), as_type<float>(v7)));
    uint v16 = ((device uint*)p0)[i];
    uint v17 = v16 >> 24u;
    uint v18 = as_type<uint>((float)(int)v17);
    uint v19 = as_type<uint>(as_type<float>(v9) * as_type<float>(v18));
    uint v20 = as_type<uint>(fma(as_type<float>(v19), as_type<float>(v10), as_type<float>(v4)));
    ...
    uint v23 = as_type<uint>(as_type<float>(v22) * as_type<float>(v11));
    uint v24 = as_type<uint>(as_type<float>(v12) + as_type<float>(v23));
    ...
    uint v34 = as_type<uint>(as_type<float>(v9) * as_type<float>(v27));
    uint v35 = as_type<uint>(fma(as_type<float>(v34), as_type<float>(v10), as_type<float>(v1)));
    ...
    uint v38 = as_type<uint>(as_type<float>(v9) * as_type<float>(v30));
    uint v39 = as_type<uint>(fma(as_type<float>(v38), as_type<float>(v10), as_type<float>(v2)));
    ...
    uint v42 = as_type<uint>(as_type<float>(v9) * as_type<float>(v33));
    uint v43 = as_type<uint>(fma(as_type<float>(v42), as_type<float>(v10), as_type<float>(v3)));
    ...
    uint v46 = as_type<uint>(as_type<float>(v37) * as_type<float>(v11));
    uint v47 = as_type<uint>(as_type<float>(v12) + as_type<float>(v46));
    uint v48 = (uint)(int)as_type<float>(v47);
    uint v49 = as_type<uint>(as_type<float>(v41) * as_type<float>(v11));
    uint v50 = as_type<uint>(as_type<float>(v12) + as_type<float>(v49));
    uint v51 = (uint)(int)as_type<float>(v50);
    uint v52 = as_type<uint>(as_type<float>(v45) * as_type<float>(v11));
    uint v53 = as_type<uint>(as_type<float>(v12) + as_type<float>(v52));
