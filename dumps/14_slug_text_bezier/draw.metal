...
kernel void umbra_entry(
    ...
    switch (buf_fmts[1]) {
      ...
      case 7u: { v11_c = float4(float(((device half*)(p1 + y * buf_rbs[1]))[x]),float(((device half*)(p1_g + y * buf_rbs[1]))[x]),float(((device half*)(p1_b + y * buf_rbs[1]))[x]),float(((device half*)(p1_a + y * buf_rbs[1]))[x])); break; }
    ...
    switch (buf_fmts[1]) {
      ...
      case 7u: { ((device half*)(p1 + y * buf_rbs[1]))[x] = half(sc24.x); ((device half*)(p1_g + y * buf_rbs[1]))[x] = half(sc24.y); ((device half*)(p1_b + y * buf_rbs[1]))[x] = half(sc24.z); ((device half*)(p1_a + y * buf_rbs[1]))[x] = half(sc24.w); break; }
      default: break;
    }
}
