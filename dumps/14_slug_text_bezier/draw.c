...
void umbra_entry(int n, void **ptrs, long *szs) {
    ...
    for (int i = 0; i < n; i++) {
        ...
        u32 v16 = ((u32*)pd5)[i];
        u32 v17 = (u32)(v16 & v6);
        u32 v18 = f2u(fminf(u2f(v17), u2f(v7)));
        u32 v19 = f2u(u2f(v9) * u2f(v15));
        u32 v20 = f2u(fmaf(u2f(v19), u2f(v10), u2f(v1)));
        u32 v21 = f2u(fmaf(-u2f(v9), u2f(v15), u2f(v20)));
        u32 v22 = f2u(u2f(v18) * u2f(v21));
        u32 v23 = f2u(fmaf(u2f(v9), u2f(v15), u2f(v22)));
        u32 v24 = f2u(fmaf(u2f(v23), u2f(v11), u2f(v12)));
        u32 v25 = (u32)(s32)u2f(v24);
        u32 v26 = (u32)(v8 & v25);
        u32 v27 = (u32)(v13 >> 8);
        u32 v28 = (u32)(v8 & v27);
        u32 v29 = f2u((float)(s32)v28);
        u32 v30 = f2u(u2f(v9) * u2f(v29));
        u32 v31 = f2u(fmaf(u2f(v30), u2f(v10), u2f(v2)));
        u32 v32 = f2u(fmaf(-u2f(v9), u2f(v29), u2f(v31)));
        u32 v33 = f2u(u2f(v18) * u2f(v32));
        u32 v34 = f2u(fmaf(u2f(v9), u2f(v29), u2f(v33)));
        u32 v35 = f2u(fmaf(u2f(v34), u2f(v11), u2f(v12)));
        ...
        u32 v43 = f2u(u2f(v9) * u2f(v42));
        u32 v44 = f2u(fmaf(u2f(v43), u2f(v10), u2f(v3)));
        u32 v45 = f2u(fmaf(-u2f(v9), u2f(v42), u2f(v44)));
        u32 v46 = f2u(u2f(v18) * u2f(v45));
        u32 v47 = f2u(fmaf(u2f(v9), u2f(v42), u2f(v46)));
        u32 v48 = f2u(fmaf(u2f(v47), u2f(v11), u2f(v12)));
        ...
        u32 v55 = f2u(u2f(v9) * u2f(v54));
        u32 v56 = f2u(fmaf(u2f(v55), u2f(v10), u2f(v4)));
        u32 v57 = f2u(fmaf(-u2f(v9), u2f(v54), u2f(v56)));
        u32 v58 = f2u(u2f(v18) * u2f(v57));
        u32 v59 = f2u(fmaf(u2f(v9), u2f(v54), u2f(v58)));
        u32 v60 = f2u(fmaf(u2f(v59), u2f(v11), u2f(v12)));
