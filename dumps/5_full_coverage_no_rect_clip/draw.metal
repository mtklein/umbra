...
kernel void umbra_entry(
    ...
    uint v8 = 1132396544u;
    uint v10 = (((device uint*)(p1 + y * buf_rbs[1]))[x] >> 24) & 0xFFu;
    uint v11 = as_type<uint>((float)(int)v10);
    uint v12 = as_type<uint>(as_type<float>(v11) * as_type<float>(998277249u));
    uint v13 = as_type<uint>(fma(as_type<float>(v12), as_type<float>(v7), as_type<float>(v4)));
    ...
    uint v16 = as_type<uint>(as_type<float>(v15) * as_type<float>(1132396544u));
    uint v17 = as_type<uint>((int)rint(as_type<float>(v16)));
    uint v18 = (((device uint*)(p1 + y * buf_rbs[1]))[x] >> 0) & 0xFFu;
    uint v19 = as_type<uint>((float)(int)v18);
    uint v20 = as_type<uint>(as_type<float>(v19) * as_type<float>(998277249u));
    uint v21 = as_type<uint>(fma(as_type<float>(v20), as_type<float>(v7), as_type<float>(v1)));
    ...
    uint v26 = (((device uint*)(p1 + y * buf_rbs[1]))[x] >> 8) & 0xFFu;
    uint v27 = as_type<uint>((float)(int)v26);
    uint v28 = as_type<uint>(as_type<float>(v27) * as_type<float>(998277249u));
    uint v29 = as_type<uint>(fma(as_type<float>(v28), as_type<float>(v7), as_type<float>(v2)));
    ...
    uint v34 = (((device uint*)(p1 + y * buf_rbs[1]))[x] >> 16) & 0xFFu;
    uint v35 = as_type<uint>((float)(int)v34);
    uint v36 = as_type<uint>(as_type<float>(v35) * as_type<float>(998277249u));
    uint v37 = as_type<uint>(fma(as_type<float>(v36), as_type<float>(v7), as_type<float>(v3)));
    ...
    ((device uint*)(p1 + y * buf_rbs[1]))[x] = (v25 & 0xFFu) | ((v33 & 0xFFu) << 8) | ((v41 & 0xFFu) << 16) | (v17 << 24);
}
