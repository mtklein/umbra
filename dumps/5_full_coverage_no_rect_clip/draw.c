...
void umbra_entry(int n, void **ptrs, long *szs) {
    ...
    for (int i = 0; i < n; i++) {
        ...
        u32 v14 = f2u(u2f(v6) * u2f(v13));
        u32 v15 = f2u(fmaf(u2f(v14), u2f(v8), u2f(v1)));
        u32 v16 = f2u(fmaf(u2f(v15), u2f(v9), u2f(v10)));
        u32 v17 = (u32)(s32)u2f(v16);
        u32 v18 = (u32)(v5 & v17);
        u32 v19 = (u32)(v11 >> 8);
        u32 v20 = (u32)(v5 & v19);
        u32 v21 = f2u((float)(s32)v20);
        u32 v22 = f2u(u2f(v6) * u2f(v21));
        u32 v23 = f2u(fmaf(u2f(v22), u2f(v8), u2f(v2)));
        u32 v24 = f2u(fmaf(u2f(v23), u2f(v9), u2f(v10)));
        ...
        u32 v29 = (u32)(v11 >> 16);
        u32 v30 = (u32)(v5 & v29);
        u32 v31 = f2u((float)(s32)v30);
        u32 v32 = f2u(u2f(v6) * u2f(v31));
        u32 v33 = f2u(fmaf(u2f(v32), u2f(v8), u2f(v3)));
        u32 v34 = f2u(fmaf(u2f(v33), u2f(v9), u2f(v10)));
        ...
        u32 v41 = f2u(u2f(v6) * u2f(v40));
        u32 v42 = f2u(fmaf(u2f(v41), u2f(v8), u2f(v4)));
        u32 v43 = f2u(fmaf(u2f(v42), u2f(v9), u2f(v10)));
