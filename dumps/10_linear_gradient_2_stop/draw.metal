...
kernel void umbra_entry(
    ...
    uint v27 = as_type<uint>(fma(as_type<float>(v26), as_type<float>(v4), as_type<float>(v7)));
    uint v28 = as_type<uint>(as_type<float>(v6) + as_type<float>(v27));
    uint v29 = as_type<uint>(max(as_type<float>(v0), as_type<float>(v28)));
    uint v30 = as_type<uint>(min(as_type<float>(v29), as_type<float>(v8)));
    uint v31 = as_type<uint>(fma(as_type<float>(v30), as_type<float>(v20), as_type<float>(v12)));
    uint v32 = as_type<uint>(fma(as_type<float>(v30), as_type<float>(v17), as_type<float>(v9)));
    uint v33 = as_type<uint>(fma(as_type<float>(v30), as_type<float>(v18), as_type<float>(v10)));
    uint v34 = as_type<uint>(fma(as_type<float>(v30), as_type<float>(v19), as_type<float>(v11)));
    uint v35 = as_type<uint>(as_type<float>(v31) * as_type<float>(v21));
    uint v36 = as_type<uint>(as_type<float>(v22) + as_type<float>(v35));
    uint v37 = (uint)(int)as_type<float>(v36);
    uint v38 = as_type<uint>(as_type<float>(v32) * as_type<float>(v21));
    uint v39 = as_type<uint>(as_type<float>(v22) + as_type<float>(v38));
    uint v40 = (uint)(int)as_type<float>(v39);
    uint v41 = as_type<uint>(as_type<float>(v33) * as_type<float>(v21));
    uint v42 = as_type<uint>(as_type<float>(v22) + as_type<float>(v41));
    uint v43 = (uint)(int)as_type<float>(v42);
    uint v44 = as_type<uint>(as_type<float>(v34) * as_type<float>(v21));
    uint v45 = as_type<uint>(as_type<float>(v22) + as_type<float>(v44));
