...
kernel void umbra_entry(
    ...
    uint v32 = as_type<uint>(as_type<float>(v31) * as_type<float>(v21));
    uint v33 = as_type<uint>(as_type<float>(v22) + as_type<float>(v32));
    uint v34 = (uint)(int)as_type<float>(v33);
    uint v35 = v34 & v23;
    uint v36 = as_type<uint>(fma(as_type<float>(v30), as_type<float>(v18), as_type<float>(v10)));
    uint v37 = as_type<uint>(as_type<float>(v36) * as_type<float>(v21));
    uint v38 = as_type<uint>(as_type<float>(v22) + as_type<float>(v37));
    uint v39 = (uint)(int)as_type<float>(v38);
    uint v40 = v39 & v23;
    uint v41 = v40 << 8u;
    uint v42 = v35 | v41;
    uint v43 = as_type<uint>(fma(as_type<float>(v30), as_type<float>(v19), as_type<float>(v11)));
    uint v44 = as_type<uint>(as_type<float>(v43) * as_type<float>(v21));
    uint v45 = as_type<uint>(as_type<float>(v22) + as_type<float>(v44));
    uint v46 = (uint)(int)as_type<float>(v45);
    uint v47 = v46 & v23;
    uint v48 = v47 << 16u;
    uint v49 = v42 | v48;
    uint v50 = as_type<uint>(fma(as_type<float>(v30), as_type<float>(v20), as_type<float>(v12)));
    uint v51 = as_type<uint>(as_type<float>(v50) * as_type<float>(v21));
    uint v52 = as_type<uint>(as_type<float>(v22) + as_type<float>(v51));
