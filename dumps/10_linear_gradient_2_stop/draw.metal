...
kernel void umbra_entry(
    ...
    uint v32 = as_type<uint>(max(as_type<float>(v29), as_type<float>(0u)));
    uint v33 = as_type<uint>(max(as_type<float>(v30), as_type<float>(0u)));
    uint v34 = as_type<uint>(max(as_type<float>(v31), as_type<float>(0u)));
    uint v35 = as_type<uint>(max(as_type<float>(v28), as_type<float>(0u)));
    ...
    uint v38 = as_type<uint>(min(as_type<float>(v32), as_type<float>(1065353216u)));
    uint v39 = as_type<uint>(as_type<float>(v38) * as_type<float>(1132396544u));
    uint v40 = as_type<uint>(min(as_type<float>(v33), as_type<float>(1065353216u)));
    uint v41 = as_type<uint>(as_type<float>(v40) * as_type<float>(1132396544u));
    uint v42 = as_type<uint>(min(as_type<float>(v34), as_type<float>(1065353216u)));
    uint v43 = as_type<uint>(as_type<float>(v42) * as_type<float>(1132396544u));
    uint v44 = as_type<uint>((int)rint(as_type<float>(v39)));
    uint v45 = as_type<uint>((int)rint(as_type<float>(v41)));
    uint v46 = v44 & 255u;
    uint v47 = v45 & 255u;
    uint v48 = v46 | (v47 << 8u);
    uint v49 = as_type<uint>((int)rint(as_type<float>(v43)));
    uint v50 = v49 & 255u;
    uint v51 = v48 | (v50 << 16u);
    uint v52 = as_type<uint>((int)rint(as_type<float>(v37)));
    uint v53 = v51 | (v52 << 24u);
    ((device uint*)(p1 + y * buf_rbs[1]))[x] = v53;
}
