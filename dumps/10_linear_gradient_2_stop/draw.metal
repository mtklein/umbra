...
kernel void umbra_entry(
    ...
    uint v32 = as_type<uint>(as_type<float>(v28) * as_type<float>(1132396544u));
    uint v33 = as_type<uint>(as_type<float>(v29) * as_type<float>(1132396544u));
    uint v34 = as_type<uint>(as_type<float>(v30) * as_type<float>(1132396544u));
    uint v35 = as_type<uint>(as_type<float>(v31) * as_type<float>(1132396544u));
    uint v36 = as_type<uint>((int)rint(as_type<float>(v33)));
    uint v37 = as_type<uint>((int)rint(as_type<float>(v34)));
    uint v38 = v36 & 255u;
    uint v39 = v37 & 255u;
    uint v40 = v38 | (v39 << 8u);
    uint v41 = as_type<uint>((int)rint(as_type<float>(v35)));
    uint v42 = v41 & 255u;
    uint v43 = v40 | (v42 << 16u);
    uint v44 = as_type<uint>((int)rint(as_type<float>(v32)));
