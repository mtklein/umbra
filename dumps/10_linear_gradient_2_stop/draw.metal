...
kernel void umbra_entry(
    ...
    uint v32 = as_type<uint>(as_type<float>(v28) * as_type<float>(v18));
    uint v33 = as_type<uint>((int)rint(as_type<float>(v32)));
    uint v34 = as_type<uint>(as_type<float>(v29) * as_type<float>(v18));
    uint v35 = as_type<uint>((int)rint(as_type<float>(v34)));
    uint v36 = as_type<uint>(as_type<float>(v30) * as_type<float>(v18));
    uint v37 = as_type<uint>((int)rint(as_type<float>(v36)));
    uint v38 = as_type<uint>(as_type<float>(v31) * as_type<float>(v18));
