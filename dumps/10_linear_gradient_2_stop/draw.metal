...
kernel void umbra_entry(
    ...
    uint v33 = as_type<uint>(fma(as_type<float>(v27), as_type<float>(v13), as_type<float>(v5)));
    ...
    uint v38 = v37 & 255u;
    uint v39 = as_type<uint>(fma(as_type<float>(v27), as_type<float>(v14), as_type<float>(v6)));
    ...
    uint v44 = v43 & 255u;
    uint v45 = v38 | (v44 << 8u);
    uint v46 = as_type<uint>(fma(as_type<float>(v27), as_type<float>(v15), as_type<float>(v7)));
    ...
    uint v51 = v50 & 255u;
    uint v52 = v45 | (v51 << 16u);
    uint v53 = v52 | (v32 << 24u);
