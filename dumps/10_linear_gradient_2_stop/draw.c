...
void umbra_entry(int n, void **ptrs, long *szs) {
    ...
    for (int i = 0; i < n; i++) {
        ...
        u32 v27 = f2u(fmaf(u2f(v26), u2f(v4), u2f(v7)));
        u32 v28 = f2u(u2f(v6) + u2f(v27));
        u32 v29 = f2u(fmaxf(u2f(v0), u2f(v28)));
        u32 v30 = f2u(fminf(u2f(v29), u2f(v8)));
        u32 v31 = f2u(fmaf(u2f(v30), u2f(v17), u2f(v9)));
        u32 v32 = f2u(fmaf(u2f(v31), u2f(v21), u2f(v22)));
        u32 v33 = (u32)(s32)u2f(v32);
        u32 v34 = (u32)(v33 & v23);
        u32 v35 = f2u(fmaf(u2f(v30), u2f(v18), u2f(v10)));
        u32 v36 = f2u(fmaf(u2f(v35), u2f(v21), u2f(v22)));
        u32 v37 = (u32)(s32)u2f(v36);
        u32 v38 = (u32)(v37 & v23);
        u32 v39 = (u32)(v38 << 8);
        u32 v40 = (u32)(v34 | v39);
        u32 v41 = f2u(fmaf(u2f(v30), u2f(v19), u2f(v11)));
        u32 v42 = f2u(fmaf(u2f(v41), u2f(v21), u2f(v22)));
        u32 v43 = (u32)(s32)u2f(v42);
        u32 v44 = (u32)(v43 & v23);
        u32 v45 = (u32)(v44 << 16);
        u32 v46 = (u32)(v40 | v45);
        u32 v47 = f2u(fmaf(u2f(v30), u2f(v20), u2f(v12)));
        u32 v48 = f2u(fmaf(u2f(v47), u2f(v21), u2f(v22)));
