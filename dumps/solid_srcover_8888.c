...
void umbra_entry(int n, void **ptrs, long *szs) {
    ...
    u32 v5 = 998277249u;
    u32 v6 = 1065353216u;
    u32 v7 = f2u(u2f(v6) - u2f(v4));
    u32 v8 = 1132396544u;
    u32 v9 = 1056964608u;

    for (int i = 0; i < n; i++) {
        u32 v10 = (u32)((unsigned char*)ptrs[0])[i*4+0];
        u32 v11 = f2u((float)(s32)v10);
        u32 v12 = f2u(u2f(v5) * u2f(v11));
        u32 v13 = f2u(fmaf(u2f(v12), u2f(v7), u2f(v1)));
        u32 v14 = f2u(fmaf(u2f(v13), u2f(v8), u2f(v9)));
        u32 v15 = (u32)(s32)u2f(v14);
        u32 v16 = (u32)((unsigned char*)ptrs[0])[i*4+1];
        u32 v17 = f2u((float)(s32)v16);
        u32 v18 = f2u(u2f(v5) * u2f(v17));
        u32 v19 = f2u(fmaf(u2f(v18), u2f(v7), u2f(v2)));
        u32 v20 = f2u(fmaf(u2f(v19), u2f(v8), u2f(v9)));
        u32 v21 = (u32)(s32)u2f(v20);
        u32 v22 = (u32)((unsigned char*)ptrs[0])[i*4+2];
        u32 v23 = f2u((float)(s32)v22);
        u32 v24 = f2u(u2f(v5) * u2f(v23));
        u32 v25 = f2u(fmaf(u2f(v24), u2f(v7), u2f(v3)));
        u32 v26 = f2u(fmaf(u2f(v25), u2f(v8), u2f(v9)));
        u32 v27 = (u32)(s32)u2f(v26);
        u32 v28 = (u32)((unsigned char*)ptrs[0])[i*4+3];
        u32 v29 = f2u((float)(s32)v28);
        u32 v30 = f2u(u2f(v5) * u2f(v29));
        u32 v31 = f2u(fmaf(u2f(v30), u2f(v7), u2f(v4)));
        u32 v32 = f2u(fmaf(u2f(v31), u2f(v8), u2f(v9)));
