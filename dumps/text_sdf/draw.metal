...
kernel void umbra_entry(
    ...
    uint _base19 = y * buf_stride[1] + x*4;
    uint v19 = (uint)p1[_base19];
    uint v19_1 = (uint)p1[_base19+1];
    uint v19_2 = (uint)p1[_base19+2];
    uint v19_3 = (uint)p1[_base19+3];
    ...
    { uint _base = y * buf_stride[1] + x*4;
      p1[_base] = ushort(v24); p1[_base+1] = ushort(v34); p1[_base+2] = ushort(v39); p1[_base+3] = ushort(v29); }
}
