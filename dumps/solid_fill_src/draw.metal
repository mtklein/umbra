...
kernel void umbra_entry(
    ...
    float v27 = as_type<float>(v1) - v26;
    ...
    float v33 = (float)(int)v24_3;
    float v34 = v33 * as_type<float>(998277249u);
    float v35 = as_type<float>(v4) - v34;
    ...
    ((device uint*)(p1 + y * buf_rbs[1]))[x] = (v32 & 0xFFu) | ((v48 & 0xFFu) << 8u) | ((v56 & 0xFFu) << 16u) | (v40 << 24u);
}
