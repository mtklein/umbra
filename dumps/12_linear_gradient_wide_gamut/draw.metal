...
kernel void umbra_entry(
    ...
    uint v5 = 2u;
    uint v6 = ((device const uint*)p0)[2];
    uint v7 = 1065353216u;
    uint v8 = 3u;
    uint v9 = ((device const uint*)p0)[3];
    uint v10 = 1073741824u;
    uint v11 = as_type<uint>(as_type<float>(v9) - as_type<float>(v7));
    ...
    uint v20 = as_type<uint>(as_type<float>(v19) * as_type<float>(v4));
    ...
    uint v24 = as_type<uint>(min(as_type<float>(v23), as_type<float>(v7)));
