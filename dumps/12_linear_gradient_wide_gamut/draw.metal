...
kernel void umbra_entry(
    ...
    uint v40 = as_type<uint>(fma(as_type<float>(v39), as_type<float>(v18), as_type<float>(v19)));
    ...
    uint v48 = as_type<uint>(fma(as_type<float>(v32), as_type<float>(v47), as_type<float>(v44)));
    uint v49 = as_type<uint>(fma(as_type<float>(v48), as_type<float>(v18), as_type<float>(v19)));
    uint v50 = (uint)(int)as_type<float>(v49);
    uint v51 = v50 & v20;
    uint v52 = v51 << 8u;
    uint v53 = v42 | v52;
    uint v54 = v6 + v34;
    uint v55 = ((device uint*)p2)[clamp_ix((int)v54,buf_szs[2],4)];
    uint v56 = v6 + v36;
    uint v57 = ((device uint*)p2)[clamp_ix((int)v56,buf_szs[2],4)];
    uint v58 = as_type<uint>(as_type<float>(v57) - as_type<float>(v55));
    uint v59 = as_type<uint>(fma(as_type<float>(v32), as_type<float>(v58), as_type<float>(v55)));
    uint v60 = as_type<uint>(fma(as_type<float>(v59), as_type<float>(v18), as_type<float>(v19)));
    uint v61 = (uint)(int)as_type<float>(v60);
    uint v62 = v61 & v20;
    uint v63 = v62 << 16u;
    uint v64 = v53 | v63;
    uint v65 = v8 + v34;
    uint v66 = ((device uint*)p2)[clamp_ix((int)v65,buf_szs[2],4)];
    uint v67 = v8 + v36;
    uint v68 = ((device uint*)p2)[clamp_ix((int)v67,buf_szs[2],4)];
    uint v69 = as_type<uint>(as_type<float>(v68) - as_type<float>(v66));
    uint v70 = as_type<uint>(fma(as_type<float>(v32), as_type<float>(v69), as_type<float>(v66)));
    uint v71 = as_type<uint>(fma(as_type<float>(v70), as_type<float>(v18), as_type<float>(v19)));
    uint v72 = (uint)(int)as_type<float>(v71);
    uint v73 = v72 << 24u;
    uint v74 = v64 | v73;
    ((device uint*)p0)[i] = v74;
}
