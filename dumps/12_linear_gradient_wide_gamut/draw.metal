...
kernel void umbra_entry(
    ...
    uint v44 = as_type<uint>(as_type<float>(v43) * as_type<float>(v15));
    ...
    uint v56 = as_type<uint>(as_type<float>(v55) * as_type<float>(v15));
    uint v57 = as_type<uint>((int)rint(as_type<float>(v56)));
    uint v58 = as_type<uint>(as_type<float>(v48) * as_type<float>(v15));
    uint v59 = as_type<uint>((int)rint(as_type<float>(v58)));
    uint v60 = as_type<uint>(as_type<float>(v51) * as_type<float>(v15));
