...
kernel void umbra_entry(
    ...
    uint v27 = var4;
    uint v28 = v27 + 1u;
    uint v29 = p3[min(v28, m.limit3 - 1u)] & ((v28 < m.limit3) ? ~0u : 0u);
    ...
    uint v35 = v11 + v28;
    uint v36 = p2[min(v35, m.limit2 - 1u)] & ((v35 < m.limit2) ? ~0u : 0u);
    uint v37 = p3[min(v27, m.limit3 - 1u)] & ((v27 < m.limit3) ? ~0u : 0u);
    ...
    uint v55 = v12 + v27;
    uint v56 = p2[min(v55, m.limit2 - 1u)] & ((v55 < m.limit2) ? ~0u : 0u);
    ...
    uint v61 = p2[min(v28, m.limit2 - 1u)] & ((v28 < m.limit2) ? ~0u : 0u);
    uint v62 = p2[min(v27, m.limit2 - 1u)] & ((v27 < m.limit2) ? ~0u : 0u);
    ...
    p1[y * m.stride1 + x] = half4(as_type<half>((ushort)v72), as_type<half>((ushort)v74), as_type<half>((ushort)v76), as_type<half>((ushort)v78));
}
