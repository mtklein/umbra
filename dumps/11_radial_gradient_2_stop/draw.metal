...
kernel void umbra_entry(
    ...
    uint v24 = 255u;
    uint v25 = buf_szs[0] >> 2u;
    uint v26 = i;
    uint v27 = v26 + v1;
    uint v28 = as_type<uint>((float)(int)v27);
    uint v29 = as_type<uint>(as_type<float>(v28) - as_type<float>(v4));
    uint v30 = as_type<uint>(fma(as_type<float>(v29), as_type<float>(v29), as_type<float>(v8)));
    uint v31 = as_type<uint>(sqrt(as_type<float>(v30)));
    uint v32 = as_type<uint>(as_type<float>(v6) * as_type<float>(v31));
    uint v33 = as_type<uint>(max(as_type<float>(v0), as_type<float>(v32)));
    uint v34 = as_type<uint>(min(as_type<float>(v33), as_type<float>(v9)));
    uint v35 = as_type<uint>(fma(as_type<float>(v34), as_type<float>(v18), as_type<float>(v10)));
    uint v36 = as_type<uint>(fma(as_type<float>(v35), as_type<float>(v22), as_type<float>(v23)));
    uint v37 = (uint)(int)as_type<float>(v36);
    uint v38 = v37 & v24;
    uint v39 = as_type<uint>(fma(as_type<float>(v34), as_type<float>(v19), as_type<float>(v11)));
    uint v40 = as_type<uint>(fma(as_type<float>(v39), as_type<float>(v22), as_type<float>(v23)));
    uint v41 = (uint)(int)as_type<float>(v40);
    uint v42 = v41 & v24;
    uint v43 = v42 << 8u;
    uint v44 = v38 | v43;
    uint v45 = as_type<uint>(fma(as_type<float>(v34), as_type<float>(v20), as_type<float>(v12)));
    uint v46 = as_type<uint>(fma(as_type<float>(v45), as_type<float>(v22), as_type<float>(v23)));
    uint v47 = (uint)(int)as_type<float>(v46);
    uint v48 = v47 & v24;
    uint v49 = v48 << 16u;
    uint v50 = v44 | v49;
    uint v51 = as_type<uint>(fma(as_type<float>(v34), as_type<float>(v21), as_type<float>(v13)));
    uint v52 = as_type<uint>(fma(as_type<float>(v51), as_type<float>(v22), as_type<float>(v23)));
    uint v53 = (uint)(int)as_type<float>(v52);
    uint v54 = v53 << 24u;
    uint v55 = v50 | v54;
    uint v56 = 0xffffffffu;
    uint v57 = v26 <  v25 ? 0xffffffffu : 0u;
    uint v58 = v56 & v57;
    ((device uint*)p0)[i] = v55;
}
