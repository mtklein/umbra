...
kernel void umbra_entry(
    ...
    uint v30 = as_type<uint>(min(as_type<float>(v29), as_type<float>(v4)));
    ...
    uint v35 = as_type<uint>(as_type<float>(v31) * as_type<float>(v17));
    uint v36 = as_type<uint>((int)rint(as_type<float>(v35)));
    uint v37 = as_type<uint>(as_type<float>(v32) * as_type<float>(v17));
    uint v38 = as_type<uint>((int)rint(as_type<float>(v37)));
    uint v39 = as_type<uint>(as_type<float>(v33) * as_type<float>(v17));
    uint v40 = as_type<uint>((int)rint(as_type<float>(v39)));
    uint v41 = as_type<uint>(as_type<float>(v34) * as_type<float>(v17));
