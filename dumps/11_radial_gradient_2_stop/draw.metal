...
kernel void umbra_entry(
    ...
    uint v35 = as_type<uint>(as_type<float>(v31) * as_type<float>(1132396544u));
    uint v36 = as_type<uint>(as_type<float>(v32) * as_type<float>(1132396544u));
    uint v37 = as_type<uint>(as_type<float>(v33) * as_type<float>(1132396544u));
    uint v38 = as_type<uint>(as_type<float>(v34) * as_type<float>(1132396544u));
    uint v39 = as_type<uint>((int)rint(as_type<float>(v36)));
    uint v40 = as_type<uint>((int)rint(as_type<float>(v37)));
    uint v41 = v39 & 255u;
    uint v42 = v40 & 255u;
    uint v43 = v41 | (v42 << 8u);
    uint v44 = as_type<uint>((int)rint(as_type<float>(v38)));
    uint v45 = v44 & 255u;
    uint v46 = v43 | (v45 << 16u);
    uint v47 = as_type<uint>((int)rint(as_type<float>(v35)));
    uint v48 = v46 | (v47 << 24u);
