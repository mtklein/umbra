...
kernel void umbra_entry(
    ...
    uint v20 = as_type<uint>(as_type<float>(v19) - as_type<float>(v1));
    uint v21 = y0 + pos.y;
    ...
    uint v25 = as_type<uint>(fma(as_type<float>(v20), as_type<float>(v20), as_type<float>(v24)));
    uint v26 = as_type<uint>(sqrt(as_type<float>(v25)));
    uint v27 = as_type<uint>(as_type<float>(v3) * as_type<float>(v26));
    ...
    uint v30 = as_type<uint>(fma(as_type<float>(v29), as_type<float>(v16), as_type<float>(v8)));
    ...
    uint v35 = as_type<uint>(fma(as_type<float>(v29), as_type<float>(v13), as_type<float>(v5)));
    uint v36 = as_type<uint>(max(as_type<float>(v35), as_type<float>(0u)));
    uint v37 = as_type<uint>(min(as_type<float>(v36), as_type<float>(1065353216u)));
    uint v38 = as_type<uint>(as_type<float>(v37) * as_type<float>(1132396544u));
    uint v39 = as_type<uint>((int)rint(as_type<float>(v38)));
    uint v40 = as_type<uint>(fma(as_type<float>(v29), as_type<float>(v14), as_type<float>(v6)));
    ...
    uint v45 = as_type<uint>(fma(as_type<float>(v29), as_type<float>(v15), as_type<float>(v7)));
    ...
    ((device uint*)(p1 + y * buf_rbs[1]))[x] = (v39 & 0xFFu) | ((v44 & 0xFFu) << 8) | ((v49 & 0xFFu) << 16) | (v34 << 24);
}
