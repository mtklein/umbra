...
kernel void umbra_entry(
    ...
    uint v34 = as_type<uint>(fma(as_type<float>(v33), as_type<float>(v21), as_type<float>(v13)));
    uint v35 = as_type<uint>(fma(as_type<float>(v33), as_type<float>(v18), as_type<float>(v10)));
    uint v36 = as_type<uint>(fma(as_type<float>(v33), as_type<float>(v19), as_type<float>(v11)));
    uint v37 = as_type<uint>(fma(as_type<float>(v33), as_type<float>(v20), as_type<float>(v12)));
    uint v38 = as_type<uint>(as_type<float>(v34) * as_type<float>(v22));
    uint v39 = as_type<uint>(as_type<float>(v23) + as_type<float>(v38));
    uint v40 = (uint)(int)as_type<float>(v39);
    uint v41 = as_type<uint>(as_type<float>(v35) * as_type<float>(v22));
    uint v42 = as_type<uint>(as_type<float>(v23) + as_type<float>(v41));
    uint v43 = (uint)(int)as_type<float>(v42);
    uint v44 = as_type<uint>(as_type<float>(v36) * as_type<float>(v22));
    uint v45 = as_type<uint>(as_type<float>(v23) + as_type<float>(v44));
    uint v46 = (uint)(int)as_type<float>(v45);
    uint v47 = as_type<uint>(as_type<float>(v37) * as_type<float>(v22));
