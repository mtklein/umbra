...
void umbra_entry(int n, void **ptrs, long *szs) {
    ...
    u32 v5 = p1[3];
    u32 v6 = p1[4];
    u32 v7 = f2u(u2f(v3) - u2f(v5));
    u32 v8 = f2u(u2f(v7) * u2f(v7));
    u32 v9 = 1065353216u;
    u32 v10 = p1[5];
    u32 v11 = p1[6];
    u32 v12 = p1[7];
    ...
    u32 v16 = p1[11];
    u32 v17 = p1[12];
    u32 v18 = f2u(u2f(v14) - u2f(v10));
    u32 v19 = f2u(u2f(v15) - u2f(v11));
    u32 v20 = f2u(u2f(v16) - u2f(v12));
    u32 v21 = f2u(u2f(v17) - u2f(v13));
    u32 v22 = 1132396544u;
    u32 v23 = 1056964608u;
    u32 v24 = 255u;
    ...
    for (int i = 0; i < n; i++) {
        ...
        u32 v28 = f2u(u2f(v27) - u2f(v4));
        u32 v29 = f2u(fmaf(u2f(v28), u2f(v28), u2f(v8)));
        u32 v30 = f2u(sqrtf(u2f(v29)));
        u32 v31 = f2u(u2f(v6) * u2f(v30));
        u32 v32 = f2u(fmaxf(u2f(v0), u2f(v31)));
        u32 v33 = f2u(fminf(u2f(v32), u2f(v9)));
        u32 v34 = f2u(fmaf(u2f(v33), u2f(v18), u2f(v10)));
        u32 v35 = f2u(fmaf(u2f(v34), u2f(v22), u2f(v23)));
        u32 v36 = (u32)(s32)u2f(v35);
        u32 v37 = (u32)(v36 & v24);
        u32 v38 = f2u(fmaf(u2f(v33), u2f(v19), u2f(v11)));
        u32 v39 = f2u(fmaf(u2f(v38), u2f(v22), u2f(v23)));
        u32 v40 = (u32)(s32)u2f(v39);
        u32 v41 = (u32)(v40 & v24);
        u32 v42 = (u32)(v41 << 8);
        u32 v43 = (u32)(v37 | v42);
        u32 v44 = f2u(fmaf(u2f(v33), u2f(v20), u2f(v12)));
        u32 v45 = f2u(fmaf(u2f(v44), u2f(v22), u2f(v23)));
        u32 v46 = (u32)(s32)u2f(v45);
        u32 v47 = (u32)(v46 & v24);
        u32 v48 = (u32)(v47 << 16);
        u32 v49 = (u32)(v43 | v48);
        u32 v50 = f2u(fmaf(u2f(v33), u2f(v21), u2f(v13)));
        u32 v51 = f2u(fmaf(u2f(v50), u2f(v22), u2f(v23)));
        u32 v52 = (u32)(s32)u2f(v51);
        u32 v53 = (u32)(v52 << 24);
        u32 v54 = (u32)(v49 | v53);
        p0[i] = v54;
    }
