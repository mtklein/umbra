...
kernel void umbra_entry(
    ...
    uint v28 = as_type<uint>(fma(as_type<float>(v4), as_type<float>(v27), as_type<float>(v26)));
    uint v29 = as_type<uint>(as_type<float>(v28) - as_type<float>(v26));
    uint v30 = as_type<uint>(fma(as_type<float>(v23), as_type<float>(v29), as_type<float>(v26)));
    ...
    uint v35 = as_type<uint>((float)(int)v24);
    uint v36 = as_type<uint>(as_type<float>(v35) * as_type<float>(998277249u));
    uint v37 = as_type<uint>(fma(as_type<float>(v1), as_type<float>(v27), as_type<float>(v36)));
    uint v38 = as_type<uint>(as_type<float>(v37) - as_type<float>(v36));
    uint v39 = as_type<uint>(fma(as_type<float>(v23), as_type<float>(v38), as_type<float>(v36)));
    ...
    uint v44 = as_type<uint>((float)(int)v24_1);
    uint v45 = as_type<uint>(as_type<float>(v44) * as_type<float>(998277249u));
    uint v46 = as_type<uint>(fma(as_type<float>(v2), as_type<float>(v27), as_type<float>(v45)));
    uint v47 = as_type<uint>(as_type<float>(v46) - as_type<float>(v45));
    uint v48 = as_type<uint>(fma(as_type<float>(v23), as_type<float>(v47), as_type<float>(v45)));
    ...
    uint v53 = as_type<uint>((float)(int)v24_2);
    uint v54 = as_type<uint>(as_type<float>(v53) * as_type<float>(998277249u));
    uint v55 = as_type<uint>(fma(as_type<float>(v3), as_type<float>(v27), as_type<float>(v54)));
    uint v56 = as_type<uint>(as_type<float>(v55) - as_type<float>(v54));
    uint v57 = as_type<uint>(fma(as_type<float>(v23), as_type<float>(v56), as_type<float>(v54)));
