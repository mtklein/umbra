...
kernel void umbra_entry(
    ...
    uint v32 = as_type<uint>(as_type<float>(v10) - as_type<float>(v31));
    uint v33 = as_type<uint>(fma(as_type<float>(v5), as_type<float>(v32), as_type<float>(v31)));
    uint v34 = as_type<uint>(as_type<float>(v33) - as_type<float>(v31));
    uint v35 = as_type<uint>(fma(as_type<float>(v26), as_type<float>(v34), as_type<float>(v31)));
    ...
    uint v47 = as_type<uint>(fma(as_type<float>(v2), as_type<float>(v32), as_type<float>(v46)));
    uint v48 = as_type<uint>(as_type<float>(v47) - as_type<float>(v46));
    uint v49 = as_type<uint>(fma(as_type<float>(v26), as_type<float>(v48), as_type<float>(v46)));
    uint v50 = as_type<uint>(as_type<float>(v12) * as_type<float>(v42));
    uint v51 = as_type<uint>(fma(as_type<float>(v3), as_type<float>(v32), as_type<float>(v50)));
    uint v52 = as_type<uint>(as_type<float>(v51) - as_type<float>(v50));
    uint v53 = as_type<uint>(fma(as_type<float>(v26), as_type<float>(v52), as_type<float>(v50)));
    uint v54 = as_type<uint>(as_type<float>(v12) * as_type<float>(v45));
    uint v55 = as_type<uint>(fma(as_type<float>(v4), as_type<float>(v32), as_type<float>(v54)));
    uint v56 = as_type<uint>(as_type<float>(v55) - as_type<float>(v54));
    uint v57 = as_type<uint>(fma(as_type<float>(v26), as_type<float>(v56), as_type<float>(v54)));
    uint v58 = as_type<uint>(as_type<float>(v49) * as_type<float>(v13));
    uint v59 = as_type<uint>((int)rint(as_type<float>(v58)));
    uint v60 = as_type<uint>(as_type<float>(v53) * as_type<float>(v13));
    uint v61 = as_type<uint>((int)rint(as_type<float>(v60)));
    uint v62 = as_type<uint>(as_type<float>(v57) * as_type<float>(v13));
    ...
    uint v71 = v37 << 24u;
    uint v72 = v70 | v71;
    ((device uint*)p0)[clamp_ix((int)v27,buf_szs[0],4)] = v72;
}
