...
kernel void umbra_entry(
    ...
    float v41 = fma(as_type<float>(v2), v29, v40);
    float v42 = v41 - v40;
    float v43 = fma(as_type<float>(v24), v42, v40);
    ...
    float v52 = fma(as_type<float>(v3), v29, v51);
    float v53 = v52 - v51;
    float v54 = fma(as_type<float>(v24), v53, v51);
    ...
    float v62 = fma(as_type<float>(v1), v29, v61);
    float v63 = v62 - v61;
    float v64 = fma(as_type<float>(v24), v63, v61);
