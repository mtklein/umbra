...
kernel void umbra_entry(
    ...
    uint v33 = as_type<uint>(fma(as_type<float>(v7), as_type<float>(v32), as_type<float>(v31)));
    uint v34 = as_type<uint>(as_type<float>(v33) - as_type<float>(v31));
    uint v35 = as_type<uint>(fma(as_type<float>(v27), as_type<float>(v34), as_type<float>(v31)));
    uint v36 = as_type<uint>(as_type<float>(v35) * as_type<float>(v18));
    uint v37 = as_type<uint>(as_type<float>(v19) + as_type<float>(v36));
    ...
    uint v48 = as_type<uint>(fma(as_type<float>(v4), as_type<float>(v32), as_type<float>(v47)));
    uint v49 = as_type<uint>(as_type<float>(v48) - as_type<float>(v47));
    uint v50 = as_type<uint>(fma(as_type<float>(v27), as_type<float>(v49), as_type<float>(v47)));
    uint v51 = as_type<uint>(as_type<float>(v17) * as_type<float>(v43));
    uint v52 = as_type<uint>(fma(as_type<float>(v5), as_type<float>(v32), as_type<float>(v51)));
    uint v53 = as_type<uint>(as_type<float>(v52) - as_type<float>(v51));
    uint v54 = as_type<uint>(fma(as_type<float>(v27), as_type<float>(v53), as_type<float>(v51)));
    uint v55 = as_type<uint>(as_type<float>(v17) * as_type<float>(v46));
    uint v56 = as_type<uint>(fma(as_type<float>(v6), as_type<float>(v32), as_type<float>(v55)));
    uint v57 = as_type<uint>(as_type<float>(v56) - as_type<float>(v55));
    uint v58 = as_type<uint>(fma(as_type<float>(v27), as_type<float>(v57), as_type<float>(v55)));
    uint v59 = as_type<uint>(as_type<float>(v50) * as_type<float>(v18));
    uint v60 = as_type<uint>(as_type<float>(v19) + as_type<float>(v59));
    uint v61 = (uint)(int)as_type<float>(v60);
    uint v62 = as_type<uint>(as_type<float>(v54) * as_type<float>(v18));
    uint v63 = as_type<uint>(as_type<float>(v19) + as_type<float>(v62));
    uint v64 = (uint)(int)as_type<float>(v63);
    uint v65 = as_type<uint>(as_type<float>(v58) * as_type<float>(v18));
    uint v66 = as_type<uint>(as_type<float>(v19) + as_type<float>(v65));
