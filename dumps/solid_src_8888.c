...
void umbra_entry(int n, void **ptrs, long *szs) {
    ...
    u32 v6 = 1132396544u;
    u32 v7 = 1056964608u;
    u32 v8 = f2u(fmaf(u2f(v1), u2f(v6), u2f(v7)));
    u32 v9 = (u32)(s32)u2f(v8);
    u32 v10 = f2u(fmaf(u2f(v2), u2f(v6), u2f(v7)));
    u32 v11 = (u32)(s32)u2f(v10);
    u32 v12 = f2u(fmaf(u2f(v3), u2f(v6), u2f(v7)));
    u32 v13 = (u32)(s32)u2f(v12);
    u32 v14 = f2u(fmaf(u2f(v4), u2f(v6), u2f(v7)));
