...
kernel void umbra_entry(
    ...
    uint v21 = as_type<uint>(as_type<float>(v20) - as_type<float>(v5));
    ...
    uint v25 = as_type<uint>(as_type<float>(v7) * as_type<float>(v24));
    uint v26 = as_type<uint>(max(as_type<float>(v0), as_type<float>(v25)));
    uint v27 = as_type<uint>(min(as_type<float>(v26), as_type<float>(v8)));
    uint v28 = as_type<uint>(as_type<float>(v27) * as_type<float>(v11));
    uint v29 = as_type<uint>(floor(as_type<float>(v28)));
    uint v30 = as_type<uint>(min(as_type<float>(v12), as_type<float>(v29)));
