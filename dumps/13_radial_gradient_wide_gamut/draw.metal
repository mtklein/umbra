...
kernel void umbra_entry(
    ...
    uint v38 = as_type<uint>(as_type<float>(v37) - as_type<float>(v34));
    uint v39 = v35 + 1u;
    ...
    uint v43 = as_type<uint>(as_type<float>(v28) - as_type<float>(v30));
    uint v44 = as_type<uint>(fma(as_type<float>(v43), as_type<float>(v38), as_type<float>(v34)));
    ...
    uint v51 = as_type<uint>(as_type<float>(v40) - as_type<float>(v50));
    uint v52 = as_type<uint>(fma(as_type<float>(v43), as_type<float>(v51), as_type<float>(v50)));
    ...
    uint v60 = as_type<uint>(as_type<float>(v42) - as_type<float>(v59));
    uint v61 = as_type<uint>(fma(as_type<float>(v43), as_type<float>(v60), as_type<float>(v59)));
    ...
    uint v66 = v65 & 255u;
    uint v67 = ((device uint*)p2)[safe_ix((int)v35,buf_szs[2],4)] & oob_mask((int)v35,buf_szs[2],4);
    ...
    uint v70 = as_type<uint>(fma(as_type<float>(v43), as_type<float>(v69), as_type<float>(v68)));
    ...
    uint v75 = v74 & 255u;
    uint v76 = v75 | (v57 << 8u);
    uint v77 = v76 | (v66 << 16u);
    uint v78 = v77 | (v48 << 24u);
