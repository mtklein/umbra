...
kernel void umbra_entry(
    ...
    constant uint *buf_fmts [[buffer(10)]],
    constant float *buf_transfers [[buffer(11)]],
    device uchar *p0 [[buffer(0)]],
    device uchar *p1 [[buffer(1)]],
    device uchar *p2 [[buffer(2)]],
    device uchar *p3 [[buffer(3)]],
    device uchar *p4 [[buffer(4)]],
    device uchar *p0_g [[buffer(12)]],
    device uchar *p0_b [[buffer(13)]],
    device uchar *p0_a [[buffer(14)]],
    device uchar *p1_g [[buffer(15)]],
    device uchar *p1_b [[buffer(16)]],
    device uchar *p1_a [[buffer(17)]],
    device uchar *p2_g [[buffer(18)]],
    device uchar *p2_b [[buffer(19)]],
    device uchar *p2_a [[buffer(20)]],
    device uchar *p3_g [[buffer(21)]],
    device uchar *p3_b [[buffer(22)]],
    device uchar *p3_a [[buffer(23)]],
    device uchar *p4_g [[buffer(24)]],
    device uchar *p4_b [[buffer(25)]],
    device uchar *p4_a [[buffer(26)]],
